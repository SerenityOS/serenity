...
pre_configure() {
    # Fix the GpgmeppConfig.cmake file to use the correct path for cross-compilation
    run sed -i'.bak' "s#/usr/local#${SERENITY_INSTALL_ROOT}/usr/local#g" ${SERENITY_INSTALL_ROOT}/usr/local/lib/cmake/Gpgmepp/GpgmeppConfig.cmake
}
...
post_install() {
    # Restore the GpgmeppConfig.cmake file
    run mv ${SERENITY_INSTALL_ROOT}/usr/local/lib/cmake/Gpgmepp/GpgmeppConfig.cmake.bak ${SERENITY_INSTALL_ROOT}/usr/local/lib/cmake/Gpgmepp/GpgmeppConfig.cmake
}
