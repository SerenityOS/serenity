...
/**
 * This class is used as debuggee application for the interfaces001 JDI test.
 */
...
public class interfaces001a {
    ...
    private static void log1(String message) {
        if (verbMode)
            System.err.println("**> interfaces001a: " + message);
    }
...
class Class2ForCheck implements Iface2, Iface3 {
