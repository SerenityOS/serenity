...
/**
 */
public class definedclasses003 {
    ...
    private final static String className = "definedclasses003";
    ...
    private static void execTest() {
        ...
        while (true) {
            ...
            if (!refType1.isPrepared()) {
                complain("isPrepared() returned false for " + refType1);
                exitStatus = Consts.TEST_FAILED;
                break;
            } else {
                display("isPrepared() returned true for " + refType1);
            }
            ...
            boolean found = false;
            display("Searching in the list for ReferenceType : " + refType1);
            ...
            if (found) {
                display("ReferenceType : " + refType1 + "\n\t is found in definedClasses() list of " + classLoaderName + " mirror.");
            } else {
                complain("ReferenceType : " + refType1 + "\n\t is NOT found in definedClasses() list of " + classLoaderName + " mirror.");
                exitStatus = Consts.TEST_FAILED;
            }
