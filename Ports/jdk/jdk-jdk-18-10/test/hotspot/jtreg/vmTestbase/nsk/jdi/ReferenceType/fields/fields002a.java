...
//        package_prefix = "";    //  for DEBUG without package
    ...
    public static void main (String argv[]) {
        ...
        System.err.println("!!**> fields002a: FAILED!");
 ...
 */
class fields002aClassLoader extends ClassLoader {

    private String classPath;
    public static Class loadedClass;

    public fields002aClassLoader(String classPath, String className) {
        super(fields002aClassLoader.class.getClassLoader());
