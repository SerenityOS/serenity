...
/**
 * This class is used as debuggee application for the framecount001 JDI test.
 */

public class framecount001a {
    ...
    //------------------------------------------------------  section tested
                ...
                case 0:
                         ...
                         label:
                         synchronized (Threadframecount001a.lockingObject) {
                             synchronized (Threadframecount001a.waitnotifyObj) {
                                 ...
                                 try {
                                     ...
                                     Threadframecount001a.waitnotifyObj.wait();
...
class Threadframecount001a extends Thread {
    ...
    void log(String str) {
        framecount001a.log2("thread2: " + str);
    }
