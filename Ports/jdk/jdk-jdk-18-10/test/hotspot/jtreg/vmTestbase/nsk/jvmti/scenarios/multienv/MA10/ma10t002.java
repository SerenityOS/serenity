...
public class ma10t002 extends DebugeeClass {
    ...
    public static int run(String argv[], PrintStream out) {
        return new ma10t002().runIt(argv, out);
    }
    ...
    // tested thread
    ma10t002Thread testedThread = null;
    ...
    public int runIt(String argv[], PrintStream out) {
        ...
        testedThread = new ma10t002Thread("Debuggee Thread");
        testedThread.start();
...
class ma10t002Thread extends Thread {
    Wicket startingBarrier = new Wicket();
    Wicket waitingBarrier = new Wicket();

    public ma10t002Thread(String name) {
        super(name);
    }
