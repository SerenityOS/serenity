 ...
 *   - sets up two MethodEntryRequests 1&2,
 *   - double restricts MethodEntryRequest1 to the RefTypes 1 and 1,
 *   - double restricts MethodEntryRequest2 to the RefTypes 1 and 2,
...
public class filter_rt003 extends TestDebuggerType1 {
    ...
    public static int run (String argv[], PrintStream out) {
        debuggeeName = "nsk.jdi.MethodEntryRequest.addClassFilter_rt.filter_rt003a";
        return new filter_rt003().runThis(argv, out);
    }

    private String testedClassName11 =
      "nsk.jdi.MethodEntryRequest.addClassFilter_rt.filter_rt003aTestClass11";

    private String testedClassName21 =
      "nsk.jdi.MethodEntryRequest.addClassFilter_rt.filter_rt003aTestClass21";
    ...
    protected void testRun() {
        ...
        for (int i = 0; ; i++) {
            ...
            switch (i) {
                ...
                eventRequest1 = setting21MethodEntryRequest(null, testClassReference11,
                                                   EventRequest.SUSPEND_ALL, property1);

                eventRequest2 = setting21MethodEntryRequest(null, testClassReference11,
                                                   EventRequest.SUSPEND_ALL, property2);

                ((MethodEntryRequest) eventRequest1).addClassFilter(testClassReference11);
                ((MethodEntryRequest) eventRequest2).addClassFilter(testClassReference21);
