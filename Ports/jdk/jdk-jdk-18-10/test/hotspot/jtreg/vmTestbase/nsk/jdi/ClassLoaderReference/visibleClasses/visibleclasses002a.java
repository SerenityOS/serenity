 ...
 */
public class visibleclasses002a {
    ...
    public static void main (String argv[]) {
        ...
        visibleclasses002a[] arr1 = {};
        visibleclasses002a[][] arr2 = {arr1};

        try {
            pipe.println(visibleclasses002.SIGNAL_READY);

            receiveSignal(visibleclasses002.SIGNAL_QUIT);
