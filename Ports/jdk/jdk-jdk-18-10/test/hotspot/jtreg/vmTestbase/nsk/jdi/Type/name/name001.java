 ...
 * original types in the debuggee in String variables   <BR>
    ...
    //------------------------------------------------------  testing section
        ...
        pipe.println("newcheck");
            ...
            for (i2 = 0; ; i2++) {
                ...
                case 0:                 // boolean
                        String blName = execClass.getValue(fsbl).type().name();
                        if (!blName.equals("boolean")) {
                            expresult = 1;
                            log3("ERROR: !blName.equals('boolean')");
                        }
                        break;

                case 1:                 // byte
                        String btName = execClass.getValue(fsbt).type().name();
                ...
                case 2:                 // char
                        String chName = execClass.getValue(fsch).type().name();
                ...
                case 3:                 // double
                        String dbName = execClass.getValue(fsdb).type().name();
                ...
                case 4:                 // float
                        String flName = execClass.getValue(fsfl).type().name();
                ...
                case 5:                 // int
                        String inName = execClass.getValue(fsin).type().name();
                ...
                case 6:                 // long
                        String lnName = execClass.getValue(fsln).type().name();
                ...
                case 7:                 // short
                        String shName = execClass.getValue(fssh).type().name();
