...
/**
 * This class is used as debuggee application for the implementors001 JDI test.
 */

public class implementors001a {
    ...
    private static void log1(String message) {
        if (verbMode)
            System.err.println("**> implementors001a: " + message);
    }
    ...
    static Class0ForCheck class0 = null;
...
interface Iface4 extends Iface0 {
    static int i3 = 0;
}

class Class0ForCheck implements Iface1{
