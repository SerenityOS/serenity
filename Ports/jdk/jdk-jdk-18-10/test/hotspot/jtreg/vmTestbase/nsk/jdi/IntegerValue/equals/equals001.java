 ...
 * <code>com.sun.jdi.IntegerValue.equals()</code>               <BR>
 ...
 *      public static integer minus1  = -1;             <BR>
 *      public static long longplus1  = +1;             <BR>
 *                                                      <BR>
 * which a debugger mirros as :                         <BR>
 *                                                      <BR>
 *      IntegerValue ivplus1_1;                         <BR>
 *      IntegerValue ivplus1_2;                         <BR>
 *      IntegerValue ivminus1;                          <BR>
 *      LongValue    lvplus1;                           <BR>
 *                                                      <BR>
 * the following is true:                               <BR>
 *                                                      <BR>
 *      ivplus1_1 == ivplus1_2                          <BR>
 *      ivplus1_1 != ivminus1                           <BR>
 *      ivplus1_1 != lvplus1                            <BR>
 * <BR>
 */
...
public class equals001 {
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            Field fiminus1  = execClass.fieldByName("minus1");
            Field flplus1   = execClass.fieldByName("longplus1");
            ...
            IntegerValue ivminus1  = (IntegerValue) execClass.getValue(fiminus1);
            LongValue    lvplus1   = (LongValue)    execClass.getValue(flplus1);
            ...
            for (i2 = 0; ; i2++) {
                ...
                case 0: if (!ivplus1_1.equals(ivplus1_2))
                            expresult = 1;
                        break;

                case 1: if (ivplus1_1.equals(ivminus1))
                            expresult = 1;
                        break;

                case 2: if (ivplus1_1.equals(lvplus1))
                            expresult = 1;
                        break;
