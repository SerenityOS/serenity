...
public class visibmethod007 {
    ...
    private final static String prefix = "nsk.jdi.ReferenceType.visibleMethods.";
    private final static String className = "visibmethod007";
    ...
    private static void check (String fieldName) {
        try {
            ...
            List<Method> l = checkedClass.visibleMethods();
            if (l.isEmpty()) {
                complain("\t ReferenceType.visibleMethods() returned empty list for type: " + className);
                exitStatus = Consts.TEST_FAILED;
            } else {
