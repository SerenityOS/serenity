 ...
 * <code>com.sun.jdi.ObjectReference.waitingThreads()</code>    <BR>
...
public class waitingthreads001 {
    ...
    public static int run (String argv[], PrintStream out) {
        return new waitingthreads001().runThis(argv, out);
    }
    ...
    private String testedClassName =
        "nsk.jdi.ObjectReference.waitingThreads.TestClass";

    //String mName = "nsk.jdi.ObjectReference.waitingThreads";
            ...
            try {
                ...
                if (!vm.canGetMonitorInfo()) {
                    ...
                    try {
                        ...
                        log2("       expected UnsupportedOperationException is thrown");
                    } catch ( Exception e2 ) {
                        testExitCode = FAILED;
