 ...
 *     <code>redefineclasses006.java</code>             - debugger              <br>
 *     <code>redefineclasses006a.java</code>            - initial debuggee      <br>
 *     <code>newclassXX/redefineclasses006a.java</code> - redefining debuggees  <br>
 *
 * This test performs the following cases:                                      <br>
 *    1. newclass01 - deleting a public method                                  <br>
 *    2. newclass02 - deleting a protected method                               <br>
 *    3. newclass03 - deleting a private method                                 <br>
 *    4. newclass04 - deleting a private package method                         <br>
...
public class redefineclasses006 {
    ...
    private final static String debuggerName = prefix + "redefineclasses006";
    private final static String debugeeName = debuggerName + "a";

    private final static String[][] subDirs = {
            {"newclass01","deleting a public method"},
            {"newclass02","deleting a protected method"},
            {"newclass03","deleting a private method"},
            {"newclass04","deleting a private package method"}
    };

    private final static String newClassFile = File.separator
                    + prefix.replace('.',File.separatorChar)
                    + "redefineclasses006a.class";
    ...
    public static int run(String argv[], PrintStream out) {
        ...
        redefineclasses006 thisTest = new redefineclasses006();
    ...
    private void execTest() throws TestBug {
        ...
        BreakpointRequest brkp = debugee.setBreakpoint(testedClass,
                                                    redefineclasses006a.brkpMethodName,
                                                    redefineclasses006a.brkpLineNumber);
        debugee.resume();
        debugee.sendSignal("continue");
