...
public class allinterfaces001a {
    ...
    private static void log1(String message) {
        if (verbMode)
            System.err.println("**> allinterfaces001a: " + message);
    }
...
class Class1ForCheck implements Iface2 {
    int method1() {
        return 1;
    }
...
class Class2ForCheck implements Iface3 {
