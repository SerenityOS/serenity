...
public class decltype002a {
    public static void main (String argv[]) {
        ArgumentHandler argHandler = new ArgumentHandler(argv);
        Log log = new Log(System.err, argHandler);
        IOPipe pipe = argHandler.createDebugeeIOPipe(log);
//        MainClass mainClass = new MainClass();
        decltype002aSameClass sameClass = new decltype002aSameClass();
        decltype002aImplClass implClass = new decltype002aImplClass();
...
class decltype002aClass {}
interface decltype002aInter {}

class decltype002aSameClass extends decltype002aMainClass {
    // All fields are the same as in MainClass
}

class decltype002aMainClass {
    ...
    decltype002aInter     E0, E1[]={E0}, E2[][]={E1};

    final     decltype002aInter EF0 = null, EF1[]={EF0}, EF2[][]={EF1};
    private   decltype002aInter EP0,        EP1[]={EP0}, EP2[][]={EP1};
    public    decltype002aInter EU0,        EU1[]={EU0}, EU2[][]={EU1};
    protected decltype002aInter ER0,        ER1[]={ER0}, ER2[][]={ER1};
    static    decltype002aInter E0S,        E1S[]={E0S}, E2S[][]={E1S};
    transient decltype002aInter ET0,        ET1[]={ET0}, ET2[][]={ET1};
    volatile  decltype002aInter EV0,        EV1[]={EV0}, EV2[][]={EV1};
}

class decltype002aImplClass implements decltype002aSameInter {}

interface decltype002aSameInter extends decltype002aMainInter {
    // All fields are the same as in MainInter
}

interface decltype002aMainInter {
    ...
    final     decltype002aInter EF0 = null, EF1[]={EF0}, EF2[][]={EF1};
    public    decltype002aInter EU0 = null, EU1[]={EU0}, EU2[][]={EU1};
    static    decltype002aInter E0S = null, E1S[]={E0S}, E2S[][]={E1S};
}
