...
public class isfinal002a {
    ...
    static isfinal002Enum2 f3 = isfinal002Enum2.e2;
    static isfinal002Enum2.Enum2_ f4 = isfinal002Enum2.Enum2_.e1;
    ...
    public static void main (String argv[]) {
        ...
        pipe.println(isfinal002.SIGNAL_READY);


        //pipe.println(isfinal002.SIGNAL_GO);
        receiveSignal(isfinal002.SIGNAL_QUIT);
