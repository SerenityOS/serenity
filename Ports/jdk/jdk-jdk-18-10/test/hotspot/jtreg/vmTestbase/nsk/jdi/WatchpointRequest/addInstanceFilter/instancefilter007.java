 ...
 *     in the class instancefilter007aTestClass which will be calling by both threads,
 *   - restricts the AccessWatchpointRequest1 to the tread1 and
 *     to the array elements #0 & #0 calling only within thread1,
 *   - restricts the AccessWatchpointRequest2 to the thread2 and
...
public class instancefilter007 extends TestDebuggerType1 {
    ...
    public static int run (String argv[], PrintStream out) {
        debuggeeName = "nsk.jdi.WatchpointRequest.addInstanceFilter.instancefilter007a";
        return new instancefilter007().runThis(argv, out);
    }

    private String testedClassName =
      "nsk.jdi.WatchpointRequest.addInstanceFilter.instancefilter007aTestClass";
    ...
    protected void testRun() {
        ...
        for (int i = 0; ; i++) {
            ...
            switch (i) {
                ...
                display("......waiting for AccessWatchpointEvent in expected thread");
