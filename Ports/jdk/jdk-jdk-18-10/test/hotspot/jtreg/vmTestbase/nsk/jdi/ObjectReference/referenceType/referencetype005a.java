...
public class referencetype005a {
    ...
    static referencetype005aTestClass obj = new referencetype005aTestClass();
...
class referencetype005aTestClass {

    static referencetype005aClassForCheck[] cfc  = { new referencetype005aClassForCheck(), new referencetype005aClassForCheck() };
}

class referencetype005aClassForCheck {
