 ...
 */
public class classfloadhk008 extends DebugeeClass {

    /** Load native library if required. */
    static {
        System.loadLibrary("classfloadhk008");
    }
    ...
    public static int run(String argv[], PrintStream out) {
        return new classfloadhk008().runIt(argv, out);
    }
    ...
    public static final String TESTED_CLASS_NAME = PACKAGE_NAME + ".classfloadhk008r";
    ...
    public int runIt(String argv[], PrintStream out) {
        ...
        String origPath = location + File.separator + "classes";
