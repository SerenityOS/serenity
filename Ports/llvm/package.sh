...
files=(
    "https://github.com/llvm/llvm-project/releases/download/llvmorg-${version}/llvm-project-${version}.src.tar.xz#6787a69b5c40f1db32cdcf21c15828419f10ca6921e4d0dc2a81854072f73a74"
)
depends=(
    "ncurses"
    "zlib"
