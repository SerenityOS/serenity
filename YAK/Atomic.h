...
{
    atomic_signal_fence(YAK::MemoryOrder::memory_order_acq_rel);
    atomic_thread_fence(YAK::MemoryOrder::memory_order_acq_rel);
}
...
template<typename T, MemoryOrder DefaultMemoryOrder = YAK::MemoryOrder::memory_order_seq_cst>
class Atomic {
    T m_value { 0 };
