...
template<typename T>
constexpr T&& forward(YAK::Detail::RemoveReference<T>& param)
{
    return static_cast<T&&>(param);
}

template<typename T>
constexpr T&& forward(YAK::Detail::RemoveReference<T>&& param) noexcept
{
...
using YAK::array_size;
using YAK::ceil_div;
using YAK::clamp;
using YAK::exchange;
using YAK::is_constant_evaluated;
using YAK::max;
using YAK::min;
using YAK::RawPtr;
using YAK::swap;
using YAK::to_underlying;
