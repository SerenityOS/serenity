...
#ifdef __i386__
#    define YAK_ARCH_I386 1
#endif

#ifdef __x86_64__
#    define YAK_ARCH_X86_64 1
#endif

#if defined(__APPLE__) && defined(__MACH__)
#    define YAK_OS_MACOS
#    define YAK_OS_BSD_GENERIC
#endif
...
#define ARCH(arch) (defined(YAK_ARCH_##arch) && YAK_ARCH_##arch)

#if !defined(__clang__)
#    define YAK_HAS_CONDITIONALLY_TRIVIAL
#endif
