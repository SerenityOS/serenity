...
using YAK::is_ascii;
using YAK::is_ascii_alpha;
using YAK::is_ascii_alphanumeric;
using YAK::is_ascii_blank;
using YAK::is_ascii_c0_control;
using YAK::is_ascii_control;
using YAK::is_ascii_digit;
using YAK::is_ascii_graphical;
using YAK::is_ascii_hex_digit;
using YAK::is_ascii_lower_alpha;
using YAK::is_ascii_printable;
using YAK::is_ascii_punctuation;
using YAK::is_ascii_space;
using YAK::is_ascii_upper_alpha;
using YAK::is_unicode;
using YAK::is_unicode_control;
using YAK::is_unicode_noncharacter;
using YAK::is_unicode_scalar_value;
using YAK::is_unicode_surrogate;
using YAK::parse_ascii_base36_digit;
using YAK::parse_ascii_digit;
using YAK::parse_ascii_hex_digit;
using YAK::to_ascii_base36_digit;
using YAK::to_ascii_lowercase;
using YAK::to_ascii_uppercase;
