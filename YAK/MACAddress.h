...
public:
    ...
    static Optional<MACAddress> from_string(const StringView& string)
    {
        ...
        auto a = YAK::StringUtils::convert_to_uint_from_hex(parts[0]).value_or(256);
        auto b = YAK::StringUtils::convert_to_uint_from_hex(parts[1]).value_or(256);
        auto c = YAK::StringUtils::convert_to_uint_from_hex(parts[2]).value_or(256);
        auto d = YAK::StringUtils::convert_to_uint_from_hex(parts[3]).value_or(256);
        auto e = YAK::StringUtils::convert_to_uint_from_hex(parts[4]).value_or(256);
        auto f = YAK::StringUtils::convert_to_uint_from_hex(parts[5]).value_or(256);
