...
//
#define YAK_ENUM_BITWISE_OPERATORS(Enum) \
    _YAK_ENUM_BITWISE_OPERATORS_INTERNAL(Enum, )

// Enables bitwise operators for the specified Enum type, this
// version is meant for use on enums which are private to the
// containing type.
//
#define YAK_ENUM_BITWISE_FRIEND_OPERATORS(Enum) \
    _YAK_ENUM_BITWISE_OPERATORS_INTERNAL(Enum, friend)

#define _YAK_ENUM_BITWISE_OPERATORS_INTERNAL(Enum, Prefix)                  \
                                                                           \
