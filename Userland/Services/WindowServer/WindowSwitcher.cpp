...
void WindowSwitcher::draw()
{
    ...
    for (size_t index = 0; index < m_windows.size(); ++index) {
        ...
        painter.draw_text(item_rect.translated(thumbnail_width() + 12, 0).translated(1, 1), window.computed_title(), WindowManager::the().window_title_font(), Gfx::Alignment::CenterLeft, text_color.inverted());
        painter.draw_text(item_rect.translated(thumbnail_width() + 12, 0), window.computed_title(), WindowManager::the().window_title_font(), Gfx::Alignment::CenterLeft, text_color);
        ...
        painter.draw_text(item_rect, window_details, Gfx::Alignment::CenterRight, rect_text_color);
    }
}
