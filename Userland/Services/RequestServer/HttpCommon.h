...
OwnPtr<Request> start_request(TBadgedProtocol&& protocol, ClientConnection& client, String const& method, URL const& url, const HashMap<String, String>& headers, ReadonlyBytes body, TPipeResult&& pipe_result)
{
