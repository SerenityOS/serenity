...
OwnPtr<Request> HttpsProtocol::start_request(ClientConnection& client, String const& method, URL const& url, const HashMap<String, String>& headers, ReadonlyBytes body)
{
