...
static void paint_custom_progressbar(GUI::Painter& painter, const Gfx::IntRect& rect, const Gfx::IntRect& text_rect, Palette const& palette, int min, int max, int value, StringView const& text, const Gfx::Font& font, Gfx::TextAlignment text_alignment)
{
