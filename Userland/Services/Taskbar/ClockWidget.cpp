...
ClockWidget::ClockWidget()
{
    ...
    m_prev_date->set_icon(Gfx::Bitmap::try_request_resource("go-back").release_value_but_fixme_should_propagate_errors());
    ...
    m_next_date->set_icon(Gfx::Bitmap::try_request_resource("go-forward").release_value_but_fixme_should_propagate_errors());
    ...
    m_jump_to_button->set_icon(Gfx::Bitmap::try_request_resource("calendar-date").release_value_but_fixme_should_propagate_errors());
    ...
    m_calendar_launcher->set_icon(Gfx::Bitmap::try_request_resource("app-calendar").release_value_but_fixme_should_propagate_errors());
