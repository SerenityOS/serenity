...
ClockWidget::ClockWidget()
{
    ...
    m_prev_date->set_icon(Media::ImageDecoder::load_from_file("/res/icons/16x16/go-back.png"sv).release_value_but_fixme_should_propagate_errors());
    ...
    m_next_date->set_icon(Media::ImageDecoder::load_from_file("/res/icons/16x16/go-forward.png"sv).release_value_but_fixme_should_propagate_errors());
    ...
    m_jump_to_button->set_icon(Media::ImageDecoder::load_from_file("/res/icons/16x16/calendar-date.png"sv).release_value_but_fixme_should_propagate_errors());
    ...
    m_calendar_launcher->set_icon(Media::ImageDecoder::load_from_file("/res/icons/16x16/app-calendar.png"sv).release_value_but_fixme_should_propagate_errors());
