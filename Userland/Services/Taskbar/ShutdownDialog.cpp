    ...
    : Dialog(nullptr)
{
    ...
    icon_image.set_bitmap(MUST(Gfx::Bitmap::load_from_uri("resource://icons/32x32/shutdown.png"sv)));
    ...
    set_icon(MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/power.png"sv)));
