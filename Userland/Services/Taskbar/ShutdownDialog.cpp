    ...
    : Dialog(nullptr)
{
    ...
    icon_image.set_bitmap(Gfx::Bitmap::try_request_resource("shutdown").release_value_but_fixme_should_propagate_errors());
    ...
    set_icon(Gfx::Bitmap::try_request_resource("power").release_value_but_fixme_should_propagate_errors());
