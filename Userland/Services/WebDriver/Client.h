...
private:
    ...
    ErrorOr<WebDriverSession*, HttpError> find_session_with_id(StringView session_id);
    JsonValue make_json_value(JsonValue);
    ...
    static NonnullOwnPtrVector<WebDriverSession> s_sessions;
