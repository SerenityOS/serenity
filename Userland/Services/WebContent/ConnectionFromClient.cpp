...
{
    page().handle_mousedown(position.to_type<Web::DevicePixels>(), button, buttons, modifiers);
}
...
{
    page().handle_mousemove(position.to_type<Web::DevicePixels>(), buttons, modifiers);
}
...
{
    page().handle_mouseup(position.to_type<Web::DevicePixels>(), button, buttons, modifiers);
}
...
{
    page().handle_mousewheel(position.to_type<Web::DevicePixels>(), button, buttons, modifiers, wheel_delta_x, wheel_delta_y);
}
...
{
    page().handle_doubleclick(position.to_type<Web::DevicePixels>(), button, buttons, modifiers);
}
