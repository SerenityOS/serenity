...
private:
    ...
    virtual String page_did_request_cookie(URL const&, Web::Cookie::Source) override;
    virtual void page_did_set_cookie(URL const&, const Web::Cookie::ParsedCookie&, Web::Cookie::Source) override;
