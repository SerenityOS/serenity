...
void PageHost::set_window_position(Web::DevicePixelPoint const& position)
{
    page().set_window_position(position);
}

void PageHost::set_window_size(Web::DevicePixelSize const& size)
{
...
void PageHost::page_did_request_scroll_to(Web::CSSPixelPoint const& scroll_position)
{
...
void PageHost::page_did_enter_tooltip_area(Web::CSSPixelPoint const& content_position, String const& title)
{
...
void PageHost::page_did_request_context_menu(Web::CSSPixelPoint const& content_position)
{
    m_client.async_did_request_context_menu(page().css_to_device_point(content_position).to_type<int>());
}

void PageHost::page_did_request_link_context_menu(Web::CSSPixelPoint const& content_position, const URL& url, String const& target, unsigned modifiers)
{
...
void PageHost::page_did_request_image_context_menu(Web::CSSPixelPoint const& content_position, const URL& url, String const& target, unsigned modifiers, Gfx::Bitmap const* bitmap_pointer)
{
