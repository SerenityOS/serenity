...
{
    auto active_window_icon = Gfx::Bitmap::try_request_resource("window").release_value_but_fixme_should_propagate_errors();
    ...
    auto buggie = Gfx::Bitmap::try_request_resource("buggie").release_value_but_fixme_should_propagate_errors();
    ...
    auto grid = Gfx::Bitmap::try_request_resource("grid").release_value_but_fixme_should_propagate_errors();
