...
{
    auto active_window_icon = MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/window.png"sv));
    ...
    auto buggie = MUST(Gfx::Bitmap::load_from_uri("resource://graphics/buggie.png"sv));
    ...
    auto grid = MUST(Gfx::Bitmap::load_from_uri("resource://wallpapers/grid.png"sv));
