...
ErrorOr<int> serenity_main(Main::Arguments arguments)
{
    ...
    export_submenu->add_action(GUI::Action::create("As &BMP..."_string,
        [&](GUI::Action&) {
    ...
    export_submenu->add_action(GUI::Action::create("As &PNG..."_string, { Mod_Ctrl | Mod_Shift, Key_S },
        [&](GUI::Action&) {
    ...
    export_submenu->add_action(GUI::Action::create("As &QOI..."_string,
        [&](GUI::Action&) {
