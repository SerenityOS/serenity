...
GalleryWidget::GalleryWidget()
{
    ...
    m_button_icons.append(Gfx::Bitmap::try_request_resource("book-open").release_value_but_fixme_should_propagate_errors());
    m_button_icons.append(Gfx::Bitmap::try_request_resource("inspector-object").release_value_but_fixme_should_propagate_errors());
    m_button_icons.append(Gfx::Bitmap::try_request_resource("ladybug").release_value_but_fixme_should_propagate_errors());
    ...
    m_font_button->set_icon(Gfx::Bitmap::try_request_resource("app-font-editor").release_value_but_fixme_should_propagate_errors());
    ...
    m_file_button->set_icon(Gfx::Bitmap::try_request_resource("open").release_value_but_fixme_should_propagate_errors());
    ...
    m_input_button->set_icon(Gfx::Bitmap::try_request_resource("properties").release_value_but_fixme_should_propagate_errors());
    ...
    m_msgbox_button->set_icon(Gfx::Bitmap::try_request_resource("app-browser").release_value_but_fixme_should_propagate_errors());
