...
GalleryWidget::GalleryWidget()
{
    ...
    m_button_icons.append(MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/book-open.png"sv)));
    m_button_icons.append(MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/inspector-object.png"sv)));
    m_button_icons.append(MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/ladybug.png"sv)));
    ...
    m_font_button->set_icon(MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/app-font-editor.png"sv)));
    ...
    m_file_button->set_icon(MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/open.png"sv)));
    ...
    m_input_button->set_icon(MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/properties.png"sv)));
    ...
    m_msgbox_button->set_icon(MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/app-browser.png"sv)));
