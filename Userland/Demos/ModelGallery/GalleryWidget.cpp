...
ErrorOr<void> GalleryWidget::load_basic_model_tab()
{
    ...
    m_add_new_item->set_icon(Gfx::Bitmap::try_request_resource("plus").release_value_but_fixme_should_propagate_errors());
    m_remove_selected_item->set_icon(Gfx::Bitmap::try_request_resource("minus").release_value_but_fixme_should_propagate_errors());
