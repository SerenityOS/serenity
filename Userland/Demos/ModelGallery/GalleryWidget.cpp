...
ErrorOr<void> GalleryWidget::load_basic_model_tab()
{
    ...
    m_add_new_item->set_icon(Media::ImageDecoder::load_from_file("/res/icons/16x16/plus.png"sv).release_value_but_fixme_should_propagate_errors());
    m_remove_selected_item->set_icon(Media::ImageDecoder::load_from_file("/res/icons/16x16/minus.png"sv).release_value_but_fixme_should_propagate_errors());
