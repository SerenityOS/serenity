...
ErrorOr<NonnullOwnPtr<DeflateDecompressor>> DeflateDecompressor::construct(MaybeOwned<Core::Stream> stream)
{
...
DeflateDecompressor::DeflateDecompressor(MaybeOwned<Core::Stream> stream, CircularBuffer output_buffer)
...
ErrorOr<NonnullOwnPtr<DeflateCompressor>> DeflateCompressor::construct(MaybeOwned<Core::Stream> stream, CompressionLevel compression_level)
{
...
ErrorOr<ByteBuffer> DeflateCompressor::compress_all(ReadonlyBytes bytes, CompressionLevel compression_level)
{
    ...
    auto deflate_stream = TRY(DeflateCompressor::construct(MaybeOwned<Core::Stream>(*output_stream), compression_level));
