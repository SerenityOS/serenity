...
ErrorOr<NonnullOwnPtr<ZlibCompressor>> ZlibCompressor::construct(MaybeOwned<Core::Stream> stream, ZlibCompressionLevel compression_level)
{
...
ZlibCompressor::ZlibCompressor(MaybeOwned<Core::Stream> stream, NonnullOwnPtr<Core::Stream> compressor_stream)
...
ErrorOr<ByteBuffer> ZlibCompressor::compress_all(ReadonlyBytes bytes, ZlibCompressionLevel compression_level)
{
    ...
    auto zlib_stream = TRY(ZlibCompressor::construct(MaybeOwned<Core::Stream>(*output_stream), compression_level));
