...
static ErrorOr<NonnullRefPtr<Gfx::Bitmap>> decode_qoi_image(Stream& stream, u32 width, u32 height)
{
...
Gfx::IntSize QOIImageDecoderPlugin::size()
{
...
ErrorOr<ImageFrameDescriptor> QOIImageDecoderPlugin::frame(size_t index, Optional<Gfx::IntSize>)
{
    if (index > 0)
