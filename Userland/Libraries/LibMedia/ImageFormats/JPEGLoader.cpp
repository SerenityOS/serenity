...
#include <LibMedia/ImageFormats/JPEGShared.h>
...
{
    context.bitmap = TRY(Gfx::Bitmap::create(Gfx::BitmapFormat::BGRx8888, { context.frame.width, context.frame.height }));
...
Gfx::IntSize JPEGImageDecoderPlugin::size()
{
...
ErrorOr<ImageFrameDescriptor> JPEGImageDecoderPlugin::frame(size_t index, Optional<Gfx::IntSize>)
{
    if (index > 0)
