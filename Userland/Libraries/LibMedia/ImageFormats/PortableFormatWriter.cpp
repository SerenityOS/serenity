...
ErrorOr<void> PortableFormatWriter::encode(Stream& output, Gfx::Bitmap const& bitmap, Options options)
{
...
ErrorOr<void> PortableFormatWriter::add_pixels(Stream& output, Options const& options, Gfx::Bitmap const& bitmap)
{
