...
public:
    ...
    ErrorOr<void> initialize_mcu(Gfx::Bitmap const& bitmap)
    {
...
ErrorOr<void> add_frame_header(Stream& stream, JPEGEncodingContext const& context, Gfx::Bitmap const& bitmap)
{
...
ErrorOr<void> JPEGWriter::encode(Stream& stream, Gfx::Bitmap const& bitmap, Options const& options)
{
