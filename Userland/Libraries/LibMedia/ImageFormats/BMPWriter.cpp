...
static ErrorOr<ByteBuffer> write_pixel_data(Gfx::Bitmap const& bitmap, int pixel_row_data_size, int bytes_per_pixel, bool include_alpha_channel)
{
...
ErrorOr<ByteBuffer> BMPWriter::encode(Gfx::Bitmap const& bitmap, Options options)
{
...
ErrorOr<ByteBuffer> BMPWriter::dump(Gfx::Bitmap const& bitmap, Options options)
{
