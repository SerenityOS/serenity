...
template<>
struct AK::Traits<Media::DDSHeader> : public AK::DefaultTraits<Media::DDSHeader> {
    static constexpr bool is_trivially_serializable() { return true; }
};

template<>
struct AK::Traits<Media::DDSHeaderDXT10> : public AK::DefaultTraits<Media::DDSHeaderDXT10> {
    static constexpr bool is_trivially_serializable() { return true; }
};
