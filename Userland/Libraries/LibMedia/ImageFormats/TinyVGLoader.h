...
class TinyVGDecodedImageData final : public Gfx::VectorGraphic {
public:
    using Style = Variant<Color, NonnullRefPtr<Gfx::SVGGradientPaintStyle>>;
    ...
    virtual Gfx::IntSize intrinsic_size() const override
    {
        return m_size;
    }
...
private:
    TinyVGDecodedImageData(Gfx::IntSize size, Vector<DrawCommand> draw_commands)
        : m_size(size)
