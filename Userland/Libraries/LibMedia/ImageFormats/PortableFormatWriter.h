...
public:
    ...
    static ErrorOr<void> encode(Stream&, Gfx::Bitmap const&, Options options = Options {});
...
private:
    ...
    static ErrorOr<void> add_pixels(Stream&, Options const& options, Gfx::Bitmap const&);
};
