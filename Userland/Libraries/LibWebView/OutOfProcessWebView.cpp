...
String OutOfProcessWebView::get_computed_value_for_element(i32 element_id, String const& parameter_name)
{
    return client().get_computed_value_for_element(element_id, parameter_name);
}
