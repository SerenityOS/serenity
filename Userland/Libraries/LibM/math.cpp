...
#define Make_AK_Backed1_ret(return_type, name)    \
    return_type name##l(long double arg) NOEXCEPT \
    {                                             \
        return AK::name<long double>(arg);        \
    }                                             \
    return_type name(double arg) NOEXCEPT         \
    {                                             \
        return AK::name<double>(arg);             \
    }                                             \
    return_type name##f(float arg) NOEXCEPT       \
    {                                             \
        return AK::name<float>(arg);              \
    }
...
Make_AK_Backed1_ret(long, lrint);
Make_AK_Backed1_ret(long long, llrint);
