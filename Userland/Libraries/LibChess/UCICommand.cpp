...
UCICommand UCICommand::from_string(StringView const& command)
{
...
DebugCommand DebugCommand::from_string(StringView const& command)
{
    auto tokens = command.split_view(' ');
...
IsReadyCommand IsReadyCommand::from_string(StringView const& command)
{
    auto tokens = command.split_view(' ');
...
SetOptionCommand SetOptionCommand::from_string(StringView const& command)
{
    auto tokens = command.split_view(' ');
...
PositionCommand PositionCommand::from_string(StringView const& command)
{
    auto tokens = command.split_view(' ');
...
GoCommand GoCommand::from_string(StringView const& command)
{
    auto tokens = command.split_view(' ');
    VERIFY(tokens[0] == "go");
...
StopCommand StopCommand::from_string(StringView const& command)
{
    auto tokens = command.split_view(' ');
...
IdCommand IdCommand::from_string(StringView const& command)
{
    auto tokens = command.split_view(' ');
    VERIFY(tokens[0] == "id");
    StringBuilder value;
...
UCIOkCommand UCIOkCommand::from_string(StringView const& command)
{
    auto tokens = command.split_view(' ');
...
ReadyOkCommand ReadyOkCommand::from_string(StringView const& command)
{
    auto tokens = command.split_view(' ');
...
BestMoveCommand BestMoveCommand::from_string(StringView const& command)
{
    auto tokens = command.split_view(' ');
...
InfoCommand InfoCommand::from_string([[maybe_unused]] StringView const& command)
{
