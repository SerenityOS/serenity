...
Square::Square(StringView const& name)
{
...
Move::Move(StringView const& long_algebraic)
...
Move Move::from_algebraic(StringView const& algebraic, const Color turn, Board const& board)
{
