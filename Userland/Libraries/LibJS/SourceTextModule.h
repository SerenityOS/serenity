...
public:
    ...
    virtual ThrowCompletionOr<Vector<FlyByteString>> get_exported_names(VM& vm, Vector<Module*> export_star_set) override;
    virtual ThrowCompletionOr<ResolvedBinding> resolve_export(VM& vm, FlyByteString const& export_name, Vector<ResolvedBinding> resolve_set = {}) override;
