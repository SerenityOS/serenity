...
public:
    ...
    virtual ThrowCompletionOr<Vector<FlyByteString>> get_exported_names(VM& vm, Vector<Module*> export_star_set = {}) = 0;
    virtual ThrowCompletionOr<ResolvedBinding> resolve_export(VM& vm, FlyByteString const& export_name, Vector<ResolvedBinding> resolve_set = {}) = 0;
...
private:
    Object* module_namespace_create(VM& vm, Vector<FlyByteString> unambiguous_names);
