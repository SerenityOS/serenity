...
public:
    ...
    ThrowCompletionOr<void> set_synthetic_module_export(FlyByteString const& export_name, Value export_value);
...
private:
    SyntheticModule(Vector<FlyByteString> export_names, EvaluationFunction evaluation_steps, Realm& realm, StringView filename);

    Vector<FlyByteString> m_export_names;  // [[ExportNames]]
