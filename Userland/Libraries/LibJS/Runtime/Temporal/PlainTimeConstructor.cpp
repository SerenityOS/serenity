...
Value PlainTimeConstructor::construct(FunctionObject& new_target)
{
    ...
    if (!YAK::is_within_range<u8>(hour) || !YAK::is_within_range<u8>(minute) || !YAK::is_within_range<u8>(second) || !YAK::is_within_range<u16>(millisecond) || !YAK::is_within_range<u16>(microsecond) || !YAK::is_within_range<u16>(nanosecond)) {
