...
ModuleNamespaceObject::ModuleNamespaceObject(Realm& realm, Module* module, Vector<FlyByteString> exports)
    ...
    , m_exports(move(exports))
{
    ...
    quick_sort(m_exports, [&](FlyByteString const& lhs, FlyByteString const& rhs) {
