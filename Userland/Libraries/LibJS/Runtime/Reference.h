...
Reference make_private_reference(VM&, Value base_value, FlyByteString const& private_identifier);
...
public:
    ...
    Reference(Environment& base, FlyByteString referenced_name, bool strict = false, Optional<EnvironmentCoordinate> environment_coordinate = {})
