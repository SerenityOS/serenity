...
BTreeIterator BTreeIterator::end()
{
...
size_t BTreeIterator::index() const
{
    return m_index;
}
...
bool BTreeIterator::operator==(BTreeIterator const& other) const
{
    return cmp(other) == 0;
}
...
bool BTreeIterator::operator==(Key const& other) const
{
    return cmp(other) == 0;
}
...
Key const& BTreeIterator::operator*() const
{
    VERIFY(!is_end());
    return (*m_current)[m_index];
}
