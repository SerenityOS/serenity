...
AddressRangesV5::AddressRangesV5(NonnullOwnPtr<Core::Stream> range_lists_stream, CompilationUnit const& compilation_unit)
...
AddressRangesV4::AddressRangesV4(NonnullOwnPtr<Core::Stream> ranges_stream, CompilationUnit const& compilation_unit)
