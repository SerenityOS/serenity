...
public:
    ...
    virtual void gl_delete_textures(GLsizei n, GLuint const* textures) = 0;
    ...
    virtual void gl_load_matrix(FloatMatrix4x4 const& matrix) = 0;
    ...
    virtual void gl_tex_image_2d(GLenum target, GLint level, GLint internal_format, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, GLvoid const* data) = 0;
    virtual void gl_tex_sub_image_2d(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, GLvoid const* data) = 0;
    ...
    virtual void gl_vertex_pointer(GLint size, GLenum type, GLsizei stride, void const* pointer) = 0;
    virtual void gl_color_pointer(GLint size, GLenum type, GLsizei stride, void const* pointer) = 0;
    virtual void gl_tex_coord_pointer(GLint size, GLenum type, GLsizei stride, void const* pointer) = 0;
    virtual void gl_draw_arrays(GLenum mode, GLint first, GLsizei count) = 0;
    virtual void gl_draw_elements(GLenum mode, GLsizei count, GLenum type, void const* indices) = 0;
