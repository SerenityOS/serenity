...
PDFErrorOr<NonnullRefPtr<Object>> DictObject::get_object(Document* document, ByteString const& key) const
{
...
#define DEFINE_ACCESSORS(class_name, snake_name)                                                                        \
    ...
    {                                                                                                                   \
        ...
        return cast_to<class_name>(m_elements[index]);                                                                  \
                                                                                                                        ...
                                                                                                                        \
    PDFErrorOr<NonnullRefPtr<class_name>> DictObject::get_##snake_name(Document* document, ByteString const& key) const \
    {                                                                                                                   \
        return document->resolve_to<class_name>(get_value(key));                                                        \
    }                                                                                                                   \
                                                                                                                        \
    NonnullRefPtr<class_name> DictObject::get_##snake_name(ByteString const& key) const                                 \
    {                                                                                                                   \
