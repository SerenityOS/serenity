...
public:
    ...
    FlyByteString get_name(u8 char_code) const;

    void set(CharCodeType char_code, FlyByteString const& glyph_name);

protected:
    HashMap<CharCodeType, FlyByteString> m_descriptors;
