...
public:
    ...
    virtual PDFErrorOr<Gfx::FloatPoint> append_path(Gfx::Path&, Gfx::FloatPoint, ByteString const&, Renderer const&)
    {
        return Error { Error::Type::RenderingUnsupported, "append_path not implemented for font" };
    }
