...
RefPtr<Gfx::Bitmap> Type1FontProgram::rasterize_glyph(FlyByteString const& char_name, float width, Gfx::GlyphSubpixelOffset subpixel_offset)
{
...
Gfx::Path Type1FontProgram::build_char(FlyByteString const& char_name, float width, Gfx::GlyphSubpixelOffset subpixel_offset)
{
...
Gfx::FloatPoint Type1FontProgram::glyph_translation(FlyByteString const& char_name, float width) const
{
    auto maybe_glyph = m_glyph_map.get(char_name);
    if (!maybe_glyph.has_value())
        return {};
