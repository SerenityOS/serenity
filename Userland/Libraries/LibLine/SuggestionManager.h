...
public:
    ...
    CompletionSuggestion(StringView const& completion, StringView const& trailing_trivia)
        : CompletionSuggestion(completion, trailing_trivia, {})
    {
    }

    CompletionSuggestion(StringView const& completion, StringView const& trailing_trivia, Style style);
