...
struct Configuration {
    ...
    static Configuration from_config(StringView const& libname = "line");
...
public:
    ...
    static StringMetrics actual_rendered_string_metrics(StringView const&);
    ...
    static Function<bool(Editor&)> find_internal_function(StringView const& name);
...
private:
    ...
    bool search(StringView const&, bool allow_empty = false, bool from_beginning = true);
