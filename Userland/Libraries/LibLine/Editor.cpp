...
Configuration Configuration::from_config(StringView const& libname)
{
...
void Editor::insert(StringView const& string_view)
{
...
bool Editor::search(StringView const& phrase, bool allow_empty, bool from_beginning)
{
...
StringMetrics Editor::actual_rendered_string_metrics(StringView const& string)
{
