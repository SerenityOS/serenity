...
{
    auto const& old_range = hunk.location.old_range;
    auto const& new_range = hunk.location.new_range;

    TRY(stream.write_formatted("@@ -{},{} +{},{} @@\n", old_range.start_line, old_range.number_of_lines, new_range.start_line, new_range.number_of_lines));
