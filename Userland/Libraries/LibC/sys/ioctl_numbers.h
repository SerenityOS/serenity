...
enum IOCtlNumber {
    ...
    MOUNT_IOCTL_SET_FILE_SOURCE,
    MOUNT_IOCTL_CREATE_FILESYSTEM,
...
#define MOUNT_IOCTL_SET_FILE_SOURCE MOUNT_IOCTL_SET_FILE_SOURCE
#define MOUNT_IOCTL_CREATE_FILESYSTEM MOUNT_IOCTL_CREATE_FILESYSTEM
