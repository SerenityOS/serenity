...
auto DynamicObject::HashSection::lookup_sysv_symbol(StringView const& name, u32 hash_value) const -> Optional<Symbol>
{
...
auto DynamicObject::HashSection::lookup_gnu_symbol(StringView const& name, u32 hash_value) const -> Optional<Symbol>
{
...
auto DynamicObject::lookup_symbol(StringView const& name) const -> Optional<SymbolLookupResult>
{
...
void* DynamicObject::symbol_for_name(StringView const& name)
{
