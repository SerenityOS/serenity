...
void Instruction::to_string_internal(StringBuilder& builder, u32 origin, const SymbolProvider* symbol_provider, bool x32) const
{
    ...
    auto append_mm = [&] { builder.appendff("mm%u", register_index()); };
    ...
    case OP_reg32_CR:
        append_mnemonic_space();
        builder.append(register_name(static_cast<RegisterIndex32>(modrm_byte() & 7)));
        append(", ");
        append_creg();
        break;
    case OP_CR_reg32:
    ...
    case OP_mm1_imm8:
        ...
        append_imm8();
        break;
    // FIXME: We should double check these if these access the right registers
    case OP_mm1_mm2m32:
        append_mnemonic_space();
        append_mm();
        append(", ");
