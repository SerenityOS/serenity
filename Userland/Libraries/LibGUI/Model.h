...
public:
    ...
    virtual bool accepts_drag(ModelIndex const&, const Vector<String>& mime_types) const;
    virtual Vector<ModelIndex, 1> matches(StringView const&, unsigned = MatchesFlag::AllMatching, ModelIndex const& = ModelIndex()) { return {}; }
