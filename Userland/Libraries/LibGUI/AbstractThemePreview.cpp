...
{
    m_active_window_icon = MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/window.png"sv));
    m_inactive_window_icon = MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/window.png"sv));

    m_default_close_bitmap = MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/window-close.png"sv));
    m_default_maximize_bitmap = MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/upward-triangle.png"sv));
    m_default_minimize_bitmap = MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/downward-triangle.png"sv));
