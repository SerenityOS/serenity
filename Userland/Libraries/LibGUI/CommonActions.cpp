...
{
    auto action = Action::create("&Open...", { Mod_Ctrl, Key_O }, MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/open.png"sv)), move(callback), parent);
...
{
    auto action = Action::create("&Save", { Mod_Ctrl, Key_S }, MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/save.png"sv)), move(callback), parent);
...
{
    auto action = Action::create("Save &As...", { Mod_Ctrl | Mod_Shift, Key_S }, MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/save-as.png"sv)), move(callback), parent);
...
{
    auto action = Action::create("Move to &Front", { Mod_Ctrl | Mod_Shift, Key_Up }, MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/move-to-front.png"sv)), move(callback), parent);
...
{
    auto action = Action::create("Move to &Back", { Mod_Ctrl | Mod_Shift, Key_Down }, MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/move-to-back.png"sv)), move(callback), parent);
...
{
    return Action::create("&Undo", { Mod_Ctrl, Key_Z }, MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/undo.png"sv)), move(callback), parent);
}

NonnullRefPtr<Action> make_redo_action(Function<void(Action&)> callback, Core::EventReceiver* parent)
{
    return Action::create("&Redo", { Mod_Ctrl | Mod_Shift, Key_Z }, { Mod_Ctrl, Key_Y }, MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/redo.png"sv)), move(callback), parent);
}

NonnullRefPtr<Action> make_delete_action(Function<void(Action&)> callback, Core::EventReceiver* parent)
{
    return Action::create("&Delete", { Mod_None, Key_Delete }, MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/delete.png"sv)), move(callback), parent);
}

NonnullRefPtr<Action> make_cut_action(Function<void(Action&)> callback, Core::EventReceiver* parent)
{
    auto action = Action::create("Cu&t", { Mod_Ctrl, Key_X }, MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/edit-cut.png"sv)), move(callback), parent);
...
{
    auto action = Action::create("&Copy", { Mod_Ctrl, Key_C }, MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/edit-copy.png"sv)), move(callback), parent);
...
{
    auto action = Action::create("&Paste", { Mod_Ctrl, Key_V }, MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/paste.png"sv)), move(callback), parent);
...
{
    auto action = Action::create("&Insert Emoji...", { Mod_Ctrl | Mod_Alt, Key_Space }, MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/emoji.png"sv)), move(callback), parent);
...
{
    auto action = Action::create("&Manual", { Mod_None, Key_F1 }, MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/app-help.png"sv)), move(callback), parent);
...
{
    auto action = Action::create("Go &Back", { Mod_Alt, Key_Left }, { MouseButton::Backward }, MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/go-back.png"sv)), move(callback), parent);
...
{
    auto action = Action::create("Go &Forward", { Mod_Alt, Key_Right }, { MouseButton::Forward }, MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/go-forward.png"sv)), move(callback), parent);
...
{
    return Action::create("Go &Home", { Mod_Alt, Key_Home }, MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/go-home.png"sv)), move(callback), parent);
}

NonnullRefPtr<Action> make_close_tab_action(Function<void(Action&)> callback, Core::EventReceiver* parent)
{
    auto action = Action::create("&Close Tab", { Mod_Ctrl, Key_W }, MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/close-tab.png"sv)), move(callback), parent);
...
{
    return Action::create("&Reload", { Mod_Ctrl, Key_R }, Key_F5, MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/reload.png"sv)), move(callback), parent);
}

NonnullRefPtr<Action> make_select_all_action(Function<void(Action&)> callback, Core::EventReceiver* parent)
{
    return Action::create("Select &All", { Mod_Ctrl, Key_A }, MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/select-all.png"sv)), move(callback), parent);
}

NonnullRefPtr<Action> make_rename_action(Function<void(Action&)> callback, Core::EventReceiver* parent)
{
    return Action::create("Re&name...", Key_F2, MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/rename.png"sv)), move(callback), parent);
}

NonnullRefPtr<Action> make_properties_action(Function<void(Action&)> callback, Core::EventReceiver* parent)
{
    return Action::create("P&roperties", { Mod_Alt, Key_Return }, MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/properties.png"sv)), move(callback), parent);
}

NonnullRefPtr<Action> make_zoom_in_action(Function<void(Action&)> callback, Core::EventReceiver* parent)
{
    return GUI::Action::create("Zoom &In", { Mod_Ctrl, Key_Equal }, MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/zoom-in.png"sv)), move(callback), parent);
}

NonnullRefPtr<Action> make_reset_zoom_action(Function<void(Action&)> callback, Core::EventReceiver* parent)
{
    return GUI::Action::create("&Reset Zoom", { Mod_Ctrl, Key_0 }, MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/zoom-reset.png"sv)), move(callback), parent);
}

NonnullRefPtr<Action> make_zoom_out_action(Function<void(Action&)> callback, Core::EventReceiver* parent)
{
    return GUI::Action::create("Zoom &Out", { Mod_Ctrl, Key_Minus }, MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/zoom-out.png"sv)), move(callback), parent);
}

NonnullRefPtr<Action> make_rotate_clockwise_action(Function<void(Action&)> callback, Core::EventReceiver* parent)
{
    return GUI::Action::create("Rotate Clock&wise", { Mod_Ctrl | Mod_Shift, Key_GreaterThan }, MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/edit-rotate-cw.png"sv)), move(callback), parent);
}

NonnullRefPtr<Action> make_rotate_counterclockwise_action(Function<void(Action&)> callback, Core::EventReceiver* parent)
{
    return GUI::Action::create("Rotate &Counterclockwise", { Mod_Ctrl | Mod_Shift, Key_LessThan }, MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/edit-rotate-ccw.png"sv)), move(callback), parent);
}

NonnullRefPtr<Action> make_command_palette_action(Window* window)
{
    auto action = Action::create("Find &Command...", { Mod_Ctrl | Mod_Shift, Key_A }, MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/find.png"sv)), [=](auto&) {
