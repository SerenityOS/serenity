...
SpinBox::SpinBox()
{
    ...
    m_increment_button->set_icon(MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/upward-triangle.png"sv)));
    ...
    m_decrement_button->set_icon(MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/downward-triangle.png"sv)));
