...
SpinBox::SpinBox()
{
    ...
    m_increment_button->set_icon(Gfx::Bitmap::try_request_resource("upward-triangle").release_value_but_fixme_should_propagate_errors());
    ...
    m_decrement_button->set_icon(Gfx::Bitmap::try_request_resource("downward-triangle").release_value_but_fixme_should_propagate_errors());
