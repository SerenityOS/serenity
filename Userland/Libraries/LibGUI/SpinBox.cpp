...
SpinBox::SpinBox()
{
    ...
    m_increment_button->set_icon(Media::ImageDecoder::load_from_file("/res/icons/16x16/upward-triangle.png"sv).release_value_but_fixme_should_propagate_errors());
    ...
    m_decrement_button->set_icon(Media::ImageDecoder::load_from_file("/res/icons/16x16/downward-triangle.png"sv).release_value_but_fixme_should_propagate_errors());
