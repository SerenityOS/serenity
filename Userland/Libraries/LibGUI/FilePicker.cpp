...
Optional<String> FilePicker::get_open_filepath(Window* parent_window, const String& window_title, const StringView& path, bool folder, bool center_within_parent_window)
{
    auto picker = FilePicker::construct(parent_window, folder ? Mode::OpenFolder : Mode::Open, "", path, center_within_parent_window);
...
Optional<String> FilePicker::get_save_filepath(Window* parent_window, const String& title, const String& extension, const StringView& path, bool center_within_parent_window)
{
    auto picker = FilePicker::construct(parent_window, Mode::Save, String::formatted("{}.{}", title, extension), path, center_within_parent_window);
...
FilePicker::FilePicker(Window* parent_window, Mode mode, const StringView& filename, const StringView& path, bool center_within_parent_window)
    : Dialog(parent_window, center_within_parent_window)
