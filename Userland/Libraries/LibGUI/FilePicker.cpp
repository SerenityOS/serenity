    ...
    , m_mode(mode)
{
    ...
    case Mode::OpenFolder:
        set_title("Open");
        set_icon(Gfx::Bitmap::try_request_resource("open").release_value_but_fixme_should_propagate_errors());
        break;
    case Mode::Save:
        set_title("Save as");
        set_icon(Gfx::Bitmap::try_request_resource("save-as").release_value_but_fixme_should_propagate_errors());
        break;
    }
    resize(560, 320);
    ...
    auto open_parent_directory_action = Action::create(
        "Open parent directory", { Mod_Alt, Key_Up }, Gfx::Bitmap::try_request_resource("open-parent-directory").release_value_but_fixme_should_propagate_errors(), [this](const Action&) {
    ...
    auto mkdir_action = Action::create(
        "New directory...", { Mod_Ctrl | Mod_Shift, Key_N }, Gfx::Bitmap::try_request_resource("mkdir").release_value_but_fixme_should_propagate_errors(), [this](const Action&) {
            String value;
