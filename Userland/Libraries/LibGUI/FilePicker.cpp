    ...
    , m_mode(mode)
{
    ...
    auto open_parent_directory_action = Action::create(
        "Open Parent Directory"_string, { Mod_Alt, Key_Up }, Gfx::Bitmap::load_from_file("/res/icons/16x16/open-parent-directory.png"sv).release_value_but_fixme_should_propagate_errors(), [this](Action const&) {
    ...
    auto mkdir_action = Action::create(
        "New Directory..."_string, { Mod_Ctrl | Mod_Shift, Key_N }, Gfx::Bitmap::load_from_file("/res/icons/16x16/mkdir.png"sv).release_value_but_fixme_should_propagate_errors(), [this](Action const&) {
            String value;
