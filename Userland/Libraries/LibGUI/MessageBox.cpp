...
ErrorOr<RefPtr<Gfx::Bitmap>> MessageBox::icon() const
{
    ...
    case Type::Information:
        return TRY(Gfx::Bitmap::load_from_uri("resource://icons/32x32/msgbox-information.png"sv));
    case Type::Warning:
        return TRY(Gfx::Bitmap::load_from_uri("resource://icons/32x32/msgbox-warning.png"sv));
    case Type::Error:
        return TRY(Gfx::Bitmap::load_from_uri("resource://icons/32x32/msgbox-error.png"sv));
    case Type::Question:
        return TRY(Gfx::Bitmap::load_from_uri("resource://icons/32x32/msgbox-question.png"sv));
    default:
        return nullptr;
    }
}
