...
int MessageBox::show(Window* parent_window, StringView const& text, StringView const& title, Type type, InputType input_type)
{
...
int MessageBox::show_error(Window* parent_window, StringView const& text)
{
    return show(parent_window, text, "Error", GUI::MessageBox::Type::Error, GUI::MessageBox::InputType::OK);
}

MessageBox::MessageBox(Window* parent_window, StringView const& text, StringView const& title, Type type, InputType input_type)
