...
PersistentModelIndex::PersistentModelIndex(PersistentModelIndex const& other)
...
PersistentModelIndex& PersistentModelIndex::operator=(PersistentModelIndex const& other)
{
    m_handle = other.m_handle;
    return *this;
}
