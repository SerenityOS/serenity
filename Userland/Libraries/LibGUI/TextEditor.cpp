...
void TextEditor::create_actions()
{
    ...
    if (is_multi_line()) {
        m_go_to_line_or_column_action = Action::create(
            "Go to Line/Column..."_string, { Mod_Ctrl, Key_L }, Gfx::Bitmap::load_from_file("/res/icons/16x16/go-to.png"sv).release_value_but_fixme_should_propagate_errors(), [this](auto&) {
                String value;
