...
{
    m_overflow_action = Action::create("Overflow Menu", { Mod_Ctrl | Mod_Shift, Key_O }, TRY(Media::ImageDecoder::load_from_file("/res/icons/16x16/overflow-menu.png"sv)), [&](auto&) {
