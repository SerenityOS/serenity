...
{
    auto default_accessibility_action = Action::create_checkable("Unimpaired"_string, { Mod_AltGr, Key_1 }, [&](auto&) {
        filterer.set_color_filter(nullptr);
    });
    auto pratanopia_accessibility_action = Action::create_checkable("Protanopia"_string, { Mod_AltGr, Key_2 }, [&](auto&) {
        filterer.set_color_filter(Gfx::ColorBlindnessFilter::create_protanopia());
    });
    auto pratanomaly_accessibility_action = Action::create_checkable("Protanomaly"_string, { Mod_AltGr, Key_3 }, [&](auto&) {
        filterer.set_color_filter(Gfx::ColorBlindnessFilter::create_protanomaly());
    });
    auto tritanopia_accessibility_action = Action::create_checkable("Tritanopia"_string, { Mod_AltGr, Key_4 }, [&](auto&) {
        filterer.set_color_filter(Gfx::ColorBlindnessFilter::create_tritanopia());
    });
    auto tritanomaly_accessibility_action = Action::create_checkable("Tritanomaly"_string, { Mod_AltGr, Key_5 }, [&](auto&) {
        filterer.set_color_filter(Gfx::ColorBlindnessFilter::create_tritanomaly());
    });
    auto deuteranopia_accessibility_action = Action::create_checkable("Deuteranopia"_string, { Mod_AltGr, Key_6 }, [&](auto&) {
        filterer.set_color_filter(Gfx::ColorBlindnessFilter::create_deuteranopia());
    });
    auto deuteranomaly_accessibility_action = Action::create_checkable("Deuteranomaly"_string, { Mod_AltGr, Key_7 }, [&](auto&) {
        filterer.set_color_filter(Gfx::ColorBlindnessFilter::create_deuteranomaly());
    });
    auto achromatopsia_accessibility_action = Action::create_checkable("Achromatopsia"_string, { Mod_AltGr, Key_8 }, [&](auto&) {
        filterer.set_color_filter(Gfx::ColorBlindnessFilter::create_achromatopsia());
    });
    auto achromatomaly_accessibility_action = Action::create_checkable("Achromatomaly"_string, { Mod_AltGr, Key_9 }, [&](auto&) {
