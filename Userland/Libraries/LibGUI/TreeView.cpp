...
TreeView::TreeView()
{
    ...
    m_expand_bitmap = Gfx::Bitmap::try_request_resource("treeview-expand").release_value_but_fixme_should_propagate_errors();
    m_collapse_bitmap = Gfx::Bitmap::try_request_resource("treeview-collapse").release_value_but_fixme_should_propagate_errors();
}
