...
#else
ErrorOr<NonnullOwnPtr<GUIDPartitionTable>> GUIDPartitionTable::try_to_initialize(NonnullRefPtr<Core::Stream> device_file)
{
...
#else
GUIDPartitionTable::GUIDPartitionTable(NonnullRefPtr<Core::Stream> device_file)
