...
public:
    ...
    void set_size(CSSPixelSize const&);

    void set_needs_display();
    void set_needs_display(CSSPixelRect const&);

    CSSPixelPoint const& viewport_scroll_offset() const { return m_viewport_scroll_offset; }
    ...
    void scroll_to(CSSPixelPoint const&);
    ...
    CSSPixelPoint to_top_level_position(CSSPixelPoint const&);
