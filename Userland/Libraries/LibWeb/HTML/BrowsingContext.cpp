...
void BrowsingContext::set_size(CSSPixelSize const& size)
{
    if (m_size == size)
        return;
    m_size = size;
...
void BrowsingContext::scroll_to(CSSPixelPoint const& position)
{
    if (active_document())
...
CSSPixelPoint BrowsingContext::to_top_level_position(CSSPixelPoint const& a_position)
{
