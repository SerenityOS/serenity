...
{
    m_document_icon.set_bitmap_for_size(16, Gfx::Bitmap::try_request_resource("filetype-html").release_value_but_fixme_should_propagate_errors());
    m_element_icon.set_bitmap_for_size(16, Gfx::Bitmap::try_request_resource("inspector-object").release_value_but_fixme_should_propagate_errors());
    m_text_icon.set_bitmap_for_size(16, Gfx::Bitmap::try_request_resource("filetype-unknown").release_value_but_fixme_should_propagate_errors());
