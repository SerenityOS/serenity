...
public:
    ...
    virtual Optional<HitTestResult> hit_test(CSSPixelPoint const&, HitTestType) const;
    ...
    virtual DispatchEventOfSameName handle_mousedown(Badge<EventHandler>, CSSPixelPoint const&, unsigned button, unsigned modifiers);
    virtual DispatchEventOfSameName handle_mouseup(Badge<EventHandler>, CSSPixelPoint const&, unsigned button, unsigned modifiers);
    virtual DispatchEventOfSameName handle_mousemove(Badge<EventHandler>, CSSPixelPoint const&, unsigned buttons, unsigned modifiers);
    virtual DOM::Node* mouse_event_target() const { return nullptr; }

    virtual bool handle_mousewheel(Badge<EventHandler>, CSSPixelPoint const&, unsigned buttons, unsigned modifiers, int wheel_delta_x, int wheel_delta_y);
