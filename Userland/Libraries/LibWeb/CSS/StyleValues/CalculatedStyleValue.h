...
public:
    ...
    virtual bool contains_relative_length() const = 0;
...
public:
    ...
    virtual bool contains_relative_length() const override;
...
public:
    ...
    virtual bool contains_relative_length() const override { return false; }
