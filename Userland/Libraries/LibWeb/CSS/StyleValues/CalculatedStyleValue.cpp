...
ErrorOr<NonnullOwnPtr<RoundCalculationNode>> RoundCalculationNode::create(RoundingMode mode, NonnullOwnPtr<CalculationNode> a, NonnullOwnPtr<CalculationNode> b)
{
    return adopt_nonnull_own_or_enomem(new (nothrow) RoundCalculationNode(mode, move(a), move(b)));
}

RoundCalculationNode::RoundCalculationNode(RoundingMode mode, NonnullOwnPtr<CalculationNode> a, NonnullOwnPtr<CalculationNode> b)
...
ErrorOr<NonnullOwnPtr<Atan2CalculationNode>> Atan2CalculationNode::create(NonnullOwnPtr<CalculationNode> a, NonnullOwnPtr<CalculationNode> b)
{
    return adopt_nonnull_own_or_enomem(new (nothrow) Atan2CalculationNode(move(a), move(b)));
}

Atan2CalculationNode::Atan2CalculationNode(NonnullOwnPtr<CalculationNode> a, NonnullOwnPtr<CalculationNode> b)
...
CalculatedStyleValue::CalculationResult Atan2CalculationNode::resolve(Layout::Node const* layout_node, CalculatedStyleValue::PercentageBasis const& percentage_basis) const
{
    auto node_a = m_a->resolve(layout_node, percentage_basis);
    auto node_a_value = resolve_value(node_a.value(), layout_node);
...
CalculatedStyleValue::CalculationResult HypotCalculationNode::resolve(Layout::Node const* layout_node, CalculatedStyleValue::PercentageBasis const& percentage_basis) const
{
    ...
    for (auto const& value : m_values) {
        auto child_resolved = value->resolve(layout_node, percentage_basis);
        auto child_value = resolve_value(child_resolved.value(), layout_node);
...
ErrorOr<NonnullOwnPtr<ExpCalculationNode>> ExpCalculationNode::create(NonnullOwnPtr<CalculationNode> a)
{
    return adopt_nonnull_own_or_enomem(new (nothrow) ExpCalculationNode(move(a)));
}

ExpCalculationNode::ExpCalculationNode(NonnullOwnPtr<CalculationNode> a)
...
CalculatedStyleValue::CalculationResult ExpCalculationNode::resolve(Layout::Node const* layout_node, CalculatedStyleValue::PercentageBasis const& percentage_basis) const
{
    auto node_a = m_a->resolve(layout_node, percentage_basis);
    auto node_a_value = resolve_value(node_a.value(), layout_node);
