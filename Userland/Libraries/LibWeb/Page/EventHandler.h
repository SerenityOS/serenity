...
public:
    ...
    bool handle_mouseup(CSSPixelPoint const&, unsigned button, unsigned buttons, unsigned modifiers);
    bool handle_mousedown(CSSPixelPoint const&, unsigned button, unsigned buttons, unsigned modifiers);
    bool handle_mousemove(CSSPixelPoint const&, unsigned buttons, unsigned modifiers);
    bool handle_mousewheel(CSSPixelPoint const&, unsigned button, unsigned buttons, unsigned modifiers, int wheel_delta_x, int wheel_delta_y);
    bool handle_doubleclick(CSSPixelPoint const&, unsigned button, unsigned buttons, unsigned modifiers);
