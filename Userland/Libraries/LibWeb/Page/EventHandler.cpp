...
static CSSPixelPoint compute_mouse_event_offset(CSSPixelPoint const& position, Layout::Node const& layout_node)
{
...
bool EventHandler::handle_mousewheel(CSSPixelPoint const& position, unsigned button, unsigned buttons, unsigned int modifiers, int wheel_delta_x, int wheel_delta_y)
{
    if (m_browsing_context.active_document())
...
bool EventHandler::handle_mouseup(CSSPixelPoint const& position, unsigned button, unsigned buttons, unsigned modifiers)
{
    if (m_browsing_context.active_document())
        m_browsing_context.active_document()->update_layout();
...
bool EventHandler::handle_mousedown(CSSPixelPoint const& position, unsigned button, unsigned buttons, unsigned modifiers)
{
    if (m_browsing_context.active_document())
        m_browsing_context.active_document()->update_layout();
...
bool EventHandler::handle_mousemove(CSSPixelPoint const& position, unsigned buttons, unsigned modifiers)
{
    if (m_browsing_context.active_document())
        m_browsing_context.active_document()->update_layout();
...
bool EventHandler::handle_doubleclick(CSSPixelPoint const& position, unsigned button, unsigned buttons, unsigned modifiers)
{
    if (m_browsing_context.active_document())
        m_browsing_context.active_document()->update_layout();
