...
bool EventHandler::handle_mousewheel(Gfx::IntPoint position, unsigned int buttons, unsigned int modifiers, int wheel_delta_x, int wheel_delta_y)
{
    if (m_browsing_context.active_document())
...
bool EventHandler::handle_mouseup(Gfx::IntPoint position, unsigned button, unsigned modifiers)
{
    if (m_browsing_context.active_document())
        m_browsing_context.active_document()->update_layout();
...
bool EventHandler::handle_mousedown(Gfx::IntPoint position, unsigned button, unsigned modifiers)
{
    if (m_browsing_context.active_document())
        m_browsing_context.active_document()->update_layout();
