...
void Label::handle_mousedown_on_label(Badge<Painting::TextPaintable>, CSSPixelPoint const&, unsigned button)
{
...
void Label::handle_mouseup_on_label(Badge<Painting::TextPaintable>, CSSPixelPoint const& position, unsigned button)
{
...
void Label::handle_mousemove_on_label(Badge<Painting::TextPaintable>, CSSPixelPoint const& position, unsigned)
{
    if (!m_tracking_mouse)
        return;
...
bool Label::is_inside_associated_label(LabelableNode const& control, CSSPixelPoint const& position)
{
