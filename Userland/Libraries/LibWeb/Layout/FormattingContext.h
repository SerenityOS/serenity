...
public:
    ...
    CSSPixels compute_box_y_position_with_respect_to_siblings(Box const&) const;
...
protected:
    ...
    CSSPixels calculate_fit_content_size(CSSPixels min_content_size, CSSPixels max_content_size, AvailableSize const&) const;
    ...
    CSSPixels compute_auto_height_for_block_level_element(Box const&, AvailableSpace const&) const;
