...
public:
    ...
    static float compute_width_for_replaced_element(ReplacedBox const&);
    static float compute_height_for_replaced_element(ReplacedBox const&);
...
protected:
    ...
    static float tentative_width_for_replaced_element(ReplacedBox const&, const CSS::Length& width);
    static float tentative_height_for_replaced_element(ReplacedBox const&, const CSS::Length& width);
