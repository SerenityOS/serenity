...
public:
    ...
    LineBoxFragment(Node const& layout_node, int start, int length, CSSPixelPoint const& offset, CSSPixelSize const& size, CSSPixels border_box_top, CSSPixels border_box_bottom, Type type)
    ...
    CSSPixelPoint const& offset() const { return m_offset; }
    void set_offset(CSSPixelPoint const& offset) { m_offset = offset; }
    ...
    CSSPixelSize const& size() const { return m_size; }
    ...
    CSSPixels border_box_height() const { return m_border_box_top + height() + m_border_box_bottom; }
