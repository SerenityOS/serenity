...
public:
    ...
    static bool is_inside_associated_label(LabelableNode const&, CSSPixelPoint const&);
    ...
    void handle_mousedown_on_label(Badge<Painting::TextPaintable>, CSSPixelPoint const&, unsigned button);
    void handle_mouseup_on_label(Badge<Painting::TextPaintable>, CSSPixelPoint const&, unsigned button);
    void handle_mousemove_on_label(Badge<Painting::TextPaintable>, CSSPixelPoint const&, unsigned button);
