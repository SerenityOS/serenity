...
public:
    ...
    Optional<JS::GCPtr<JS::NativeFunction>> get_function_instance(Wasm::FunctionAddress address) { return static_cast<Optional<JS::GCPtr<JS::NativeFunction>>>(m_function_instances.get(address)); }
