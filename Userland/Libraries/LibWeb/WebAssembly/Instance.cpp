    ...
    for (auto& export_ : m_module_instance->exports()) {
        export_.value().visit(
            [&](Wasm::FunctionAddress const& address) {
                Optional<JS::GCPtr<JS::FunctionObject>> object = static_cast<Optional<JS::GCPtr<JS::FunctionObject>>>(m_function_instances.get(address));
                if (!object.has_value()) {
            ...
            [&](Wasm::MemoryAddress const& address) {
                Optional<JS::GCPtr<Memory>> object = static_cast<Optional<JS::GCPtr<Memory>>>(m_memory_instances.get(address));
                if (!object.has_value()) {
            ...
            [&](Wasm::TableAddress const& address) {
                Optional<JS::GCPtr<Table>> object = static_cast<Optional<JS::GCPtr<Table>>>(m_table_instances.get(address));
                if (!object.has_value()) {
