...
class TarFileStream : public Core::Stream {
public:
...
class TarInputStream {
public:
    static ErrorOr<NonnullOwnPtr<TarInputStream>> construct(NonnullOwnPtr<Core::Stream>);
...
private:
    TarInputStream(NonnullOwnPtr<Core::Stream>);
...
public:
    TarOutputStream(MaybeOwned<Core::Stream>);
