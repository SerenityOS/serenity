...
static ErrorOr<void> decode_dx5_alpha_block(Core::Stream& stream, DDSLoadingContext& context, u64 bitmap_x, u64 bitmap_y)
{
...
static ErrorOr<void> decode_dx3_alpha_block(Core::Stream& stream, DDSLoadingContext& context, u64 bitmap_x, u64 bitmap_y)
{
...
static ErrorOr<void> decode_color_block(Core::Stream& stream, DDSLoadingContext& context, bool dxt1, u64 bitmap_x, u64 bitmap_y)
{
...
static ErrorOr<void> decode_dxt(Core::Stream& stream, DDSLoadingContext& context, DXGIFormat format, u64 width, u64 y)
{
...
static ErrorOr<void> decode_bitmap(Core::Stream& stream, DDSLoadingContext& context, DXGIFormat format, u64 width, u64 height)
{
