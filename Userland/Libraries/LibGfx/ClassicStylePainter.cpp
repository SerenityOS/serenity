...
void ClassicStylePainter::paint_radio_button(Painter& painter, IntRect const& rect, Palette const&, bool is_checked, bool is_being_pressed)
{
    if (!s_unfilled_circle_bitmap) {
        s_unfilled_circle_bitmap = Bitmap::try_request_resource("unfilled-radio-circle").release_value_but_fixme_should_propagate_errors();
        s_filled_circle_bitmap = Bitmap::try_request_resource("filled-radio-circle").release_value_but_fixme_should_propagate_errors();
        s_changing_filled_circle_bitmap = Bitmap::try_request_resource("changing-filled-radio-circle").release_value_but_fixme_should_propagate_errors();
        s_changing_unfilled_circle_bitmap = Bitmap::try_request_resource("changing-unfilled-radio-circle").release_value_but_fixme_should_propagate_errors();
    }
