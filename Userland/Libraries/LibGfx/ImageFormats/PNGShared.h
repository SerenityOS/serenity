...
{
    AK::SIMD::i16x4 a16 = AK::SIMD::simd_cast<AK::SIMD::i16x4>(a);
    AK::SIMD::i16x4 b16 = AK::SIMD::simd_cast<AK::SIMD::i16x4>(b);
    AK::SIMD::i16x4 c16 = AK::SIMD::simd_cast<AK::SIMD::i16x4>(c);

    AK::SIMD::i16x4 p16 = a16 + b16 - c16;
    AK::SIMD::i16x4 pa16 = AK::SIMD::abs(p16 - a16);
    AK::SIMD::i16x4 pb16 = AK::SIMD::abs(p16 - b16);
    AK::SIMD::i16x4 pc16 = AK::SIMD::abs(p16 - c16);

    AK::SIMD::u8x4 mask_a = AK::SIMD::simd_cast<AK::SIMD::u8x4>((pa16 <= pb16) & (pa16 <= pc16));
    AK::SIMD::u8x4 mask_b = ~mask_a & AK::SIMD::simd_cast<AK::SIMD::u8x4>(pb16 <= pc16);
    AK::SIMD::u8x4 mask_c = ~(mask_a | mask_b);
