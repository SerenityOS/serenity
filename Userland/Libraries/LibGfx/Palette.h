...
public:
    ...
    Gfx::Alignment alignment(AlignmentRole role) const
    {
...
public:
    ...
    Gfx::Alignment title_alignment() const { return alignment(AlignmentRole::TitleAlignment); }
    ...
    Gfx::Alignment alignment(AlignmentRole role) const { return m_impl->alignment(role); }
    ...
    void set_alignment(AlignmentRole, Gfx::Alignment);
