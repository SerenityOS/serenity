...
{
    static const float m0 = 2.0 * AK::cos(1.0 / 16.0 * 2.0 * M_PI);
    static const float m1 = 2.0 * AK::cos(2.0 / 16.0 * 2.0 * M_PI);
    static const float m3 = 2.0 * AK::cos(2.0 / 16.0 * 2.0 * M_PI);
    static const float m5 = 2.0 * AK::cos(3.0 / 16.0 * 2.0 * M_PI);
    static const float m2 = m0 - m5;
    static const float m4 = m0 + m5;
    static const float s0 = AK::cos(0.0 / 16.0 * M_PI) / sqrt(8);
    static const float s1 = AK::cos(1.0 / 16.0 * M_PI) / 2.0;
    static const float s2 = AK::cos(2.0 / 16.0 * M_PI) / 2.0;
    static const float s3 = AK::cos(3.0 / 16.0 * M_PI) / 2.0;
    static const float s4 = AK::cos(4.0 / 16.0 * M_PI) / 2.0;
    static const float s5 = AK::cos(5.0 / 16.0 * M_PI) / 2.0;
    static const float s6 = AK::cos(6.0 / 16.0 * M_PI) / 2.0;
    static const float s7 = AK::cos(7.0 / 16.0 * M_PI) / 2.0;
