...
{
    static const float m0 = 2.f * AK::cos(1.f / 16.f * 2.f * (float)M_PI);
    static const float m1 = 2.f * AK::cos(2.f / 16.f * 2.f * (float)M_PI);
    static const float m3 = 2.f * AK::cos(2.f / 16.f * 2.f * (float)M_PI);
    static const float m5 = 2.f * AK::cos(3.f / 16.f * 2.f * (float)M_PI);
    static const float m2 = m0 - m5;
    static const float m4 = m0 + m5;
    static const float s0 = AK::cos(0.f / 16.f * (float)M_PI) / AK::sqrt(8.f);
    static const float s1 = AK::cos(1.f / 16.f * (float)M_PI) / 2.f;
    static const float s2 = AK::cos(2.f / 16.f * (float)M_PI) / 2.f;
    static const float s3 = AK::cos(3.f / 16.f * (float)M_PI) / 2.f;
    static const float s4 = AK::cos(4.f / 16.f * (float)M_PI) / 2.f;
    static const float s5 = AK::cos(5.f / 16.f * (float)M_PI) / 2.f;
    static const float s6 = AK::cos(6.f / 16.f * (float)M_PI) / 2.f;
    static const float s7 = AK::cos(7.f / 16.f * (float)M_PI) / 2.f;
