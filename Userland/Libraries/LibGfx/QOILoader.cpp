...
static ErrorOr<QOIHeader> decode_qoi_header(Core::Stream& stream)
{
...
static ErrorOr<Color> decode_qoi_op_rgb(Core::Stream& stream, u8 first_byte, Color pixel)
{
...
static ErrorOr<Color> decode_qoi_op_rgba(Core::Stream& stream, u8 first_byte)
{
...
static ErrorOr<u8> decode_qoi_op_index(Core::Stream&, u8 first_byte)
{
...
static ErrorOr<Color> decode_qoi_op_diff(Core::Stream&, u8 first_byte, Color pixel)
{
...
static ErrorOr<Color> decode_qoi_op_luma(Core::Stream& stream, u8 first_byte, Color pixel)
{
...
static ErrorOr<u8> decode_qoi_op_run(Core::Stream&, u8 first_byte)
{
...
static ErrorOr<void> decode_qoi_end_marker(Core::Stream& stream)
{
...
static ErrorOr<NonnullRefPtr<Bitmap>> decode_qoi_image(Core::Stream& stream, u32 width, u32 height)
{
...
QOIImageDecoderPlugin::QOIImageDecoderPlugin(NonnullOwnPtr<Core::Stream> stream)
{
...
ErrorOr<void> QOIImageDecoderPlugin::decode_header_and_update_context(Core::Stream& stream)
{
...
ErrorOr<void> QOIImageDecoderPlugin::decode_image_and_update_context(Core::Stream& stream)
{
