...
static Path::StrokeStyle line_style_to_stroke_style(LineStyle style, float thickness)
{
    ...
    case LineStyle::Solid:
        return Path::StrokeStyle { .thickness = thickness, .cap_style = Path::CapStyle::Square, .join_style = Path::JoinStyle::Miter };
    ...
    case LineStyle::Dashed:
        return Path::StrokeStyle { .thickness = thickness, .cap_style = Path::CapStyle::Square, .join_style = Path::JoinStyle::Miter, .dash_pattern = { thickness, thickness } };
    }
    VERIFY_NOT_REACHED();
}
