...
static Array const s_aero_title_gradient {
...
IntRect AeroWindowTheme::titlebar_rect(WindowType window_type, WindowMode window_mode, IntRect const& window_rect, Palette const& palette) const
{
...
void AeroWindowTheme::paint_normal_frame(Painter& painter, WindowState window_state, WindowMode window_mode, IntRect const& window_rect, StringView window_title, Bitmap const& icon, Palette const& palette, IntRect const& leftmost_button_rect, int menu_row_count, bool window_modified) const
{
    ...
    painter.fill_rect_with_linear_gradient(frame_rect, s_aero_title_gradient, 45, 0.9f);
...
Vector<IntRect> AeroWindowTheme::layout_buttons(WindowType window_type, WindowMode window_mode, IntRect const& window_rect, Palette const& palette, size_t buttons) const
{
...
void AeroWindowTheme::paint_taskbar(Painter& painter, IntRect const& taskbar_rect, Palette const&) const
{
    auto base_color = Color(2, 3, 4, 219);
    painter.clear_rect(taskbar_rect, Color::Transparent);
    painter.fill_rect_with_linear_gradient(taskbar_rect, s_aero_title_gradient, 45, 0.9f);
