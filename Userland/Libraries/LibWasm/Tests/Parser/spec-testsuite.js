...
let test_function = haveSpecTestSuite ? test : test.skip;
...
for (let test_name of tests) {
    test_function(`parse ${test_name}`, () => {
        const contents = readBinaryWasmFile(`Fixtures/SpecTests/${test_name}.wasm`);
