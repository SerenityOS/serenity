...
ParseResult<Vector<Instruction>> Instruction::parse(InputStream& stream, InstructionPointer& ip)
{
    ...
    case 0xfd: {
        ...
        case Instructions::i64_trunc_sat_f64_u.value():
            return Vector { Instruction { full_opcode } };
        case Instructions::memory_init.value(): {
            ...
            return Vector { Instruction { full_opcode, index.release_value() } };
        }
        ...
        case Instructions::table_init.value(): {
            ...
            if (table_index.is_error())
                return table_index.error();
            return Vector { Instruction { full_opcode, TableElementArgs { element_index.release_value(), table_index.release_value() } } };
        }
        case Instructions::elem_drop.value(): {
            auto element_index = GenericIndexParser<ElementIndex>::parse(stream);
            if (element_index.is_error())
                return element_index.error();
            return Vector { Instruction { full_opcode, element_index.release_value() } };
        }
        case Instructions::table_copy.value(): {
            ...
            if (rhs.is_error())
                return rhs.error();
            return Vector { Instruction { full_opcode, TableTableArgs { lhs.release_value(), rhs.release_value() } } };
        }
        ...
        case Instructions::v128_store.value(): {
            ...
            return Vector { Instruction { full_opcode, MemoryArgument { static_cast<u32>(align), static_cast<u32>(offset) } } };
        }
        ...
        case Instructions::v128_store64_lane.value(): {
            ...
            return Vector { Instruction { full_opcode, MemoryAndLaneArgument { { static_cast<u32>(align), static_cast<u32>(offset) }, index } } };
        }
        case Instructions::v128_const.value(): {
            // op (literal:16)
            // FIXME: Teach LittleEndian about u128
            LittleEndian<u64> low;
            LittleEndian<u64> high;
            ...
            return Vector { Instruction { full_opcode, u128 { static_cast<u64>(low), static_cast<u64>(high) } } };
        }
        case Instructions::i8x16_shuffle.value(): {
            ...
            return Vector { Instruction { full_opcode, ShuffleArgument(lanes) } };
        }
        ...
        case Instructions::f64x2_replace_lane.value(): {
            ...
            if (stream.has_any_error())
                return with_eof_check(stream, ParseError::InvalidInput);
            return Vector { Instruction { full_opcode, LaneIndex { lane } } };
        }
