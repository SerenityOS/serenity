...
struct GenericIndexParser {
    static ParseResult<T> parse(Core::Stream& stream)
    {
...
class ReconsumableStream : public Core::Stream {
public:
    explicit ReconsumableStream(Core::Stream& stream)
        : m_stream(stream)
    {
    }
...
class ConstrainedStream : public Core::Stream {
public:
    explicit ConstrainedStream(Core::Stream& stream, size_t size)
        : m_stream(stream)
        , m_bytes_left(size)
    {
    }
...
public:
    ...
    static ParseResult<ValueType> parse(Core::Stream& stream);
...
public:
    ...
    static ParseResult<ResultType> parse(Core::Stream& stream);
...
public:
    ...
    static ParseResult<FunctionType> parse(Core::Stream& stream);
...
public:
    ...
    static ParseResult<Limits> parse(Core::Stream& stream);
...
public:
    ...
    static ParseResult<MemoryType> parse(Core::Stream& stream);
...
public:
    ...
    static ParseResult<TableType> parse(Core::Stream& stream);
...
public:
    ...
    static ParseResult<GlobalType> parse(Core::Stream& stream);
...
public:
    ...
    static ParseResult<BlockType> parse(Core::Stream& stream);
...
public:
    ...
    static ParseResult<Vector<Instruction>> parse(Core::Stream& stream, InstructionPointer& ip);
...
public:
    ...
    static ParseResult<CustomSection> parse(Core::Stream& stream);
...
public:
    ...
    static ParseResult<TypeSection> parse(Core::Stream& stream);
...
public:
    ...
    public:
        ...
        static ParseResult<Import> parse(Core::Stream& stream);
...
public:
    ...
    static ParseResult<ImportSection> parse(Core::Stream& stream);
...
public:
    ...
    static ParseResult<FunctionSection> parse(Core::Stream& stream);
...
public:
    ...
    public:
        ...
        static ParseResult<Table> parse(Core::Stream& stream);
...
public:
    ...
    static ParseResult<TableSection> parse(Core::Stream& stream);
...
public:
    ...
    public:
        ...
        static ParseResult<Memory> parse(Core::Stream& stream);
...
public:
    ...
    static ParseResult<MemorySection> parse(Core::Stream& stream);
...
public:
    ...
    static ParseResult<Expression> parse(Core::Stream& stream);
...
public:
    ...
    public:
        ...
        static ParseResult<Global> parse(Core::Stream& stream);
...
public:
    ...
    static ParseResult<GlobalSection> parse(Core::Stream& stream);
...
public:
    ...
    public:
        ...
        static ParseResult<Export> parse(Core::Stream& stream);
    ...
    static ParseResult<ExportSection> parse(Core::Stream& stream);
...
public:
    ...
    public:
        ...
        static ParseResult<StartFunction> parse(Core::Stream& stream);
    ...
    static ParseResult<StartSection> parse(Core::Stream& stream);
...
public:
    ...
    struct SegmentType0 {
        // FIXME: Implement me!
        static ParseResult<SegmentType0> parse(Core::Stream& stream);

        Vector<FunctionIndex> function_indices;
        Active mode;
    };
    struct SegmentType1 {
        static ParseResult<SegmentType1> parse(Core::Stream& stream);

        Vector<FunctionIndex> function_indices;
    };
    struct SegmentType2 {
        // FIXME: Implement me!
        static ParseResult<SegmentType2> parse(Core::Stream& stream);
    };
    struct SegmentType3 {
        // FIXME: Implement me!
        static ParseResult<SegmentType3> parse(Core::Stream& stream);
    };
    struct SegmentType4 {
        // FIXME: Implement me!
        static ParseResult<SegmentType4> parse(Core::Stream& stream);
    };
    struct SegmentType5 {
        // FIXME: Implement me!
        static ParseResult<SegmentType5> parse(Core::Stream& stream);
    };
    struct SegmentType6 {
        // FIXME: Implement me!
        static ParseResult<SegmentType6> parse(Core::Stream& stream);
    };
    struct SegmentType7 {
        // FIXME: Implement me!
        static ParseResult<SegmentType7> parse(Core::Stream& stream);
    };

    struct Element {
        static ParseResult<Element> parse(Core::Stream&);
    ...
    static ParseResult<ElementSection> parse(Core::Stream& stream);
...
public:
    ...
    static ParseResult<Locals> parse(Core::Stream& stream);
...
public:
    ...
    public:
        ...
        static ParseResult<Func> parse(Core::Stream& stream);
    ...
    public:
        ...
        static ParseResult<Code> parse(Core::Stream& stream);
    ...
    static ParseResult<CodeSection> parse(Core::Stream& stream);
...
public:
    ...
    public:
        ...
        static ParseResult<Data> parse(Core::Stream& stream);
    ...
    static ParseResult<DataSection> parse(Core::Stream& stream);
...
public:
    ...
    static ParseResult<DataCountSection> parse(Core::Stream& stream);
...
public:
    ...
    static ParseResult<Module> parse(Core::Stream& stream);
