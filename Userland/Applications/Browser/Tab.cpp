...
Tab::Tab(BrowserWindow& window)
{
    ...
    m_location_box->add_custom_context_menu_action(GUI::Action::create("Paste && Go"_string, [this](auto&) {
    ...
    auto bookmark_action = GUI::Action::create(
        "Bookmark current URL"_string, { Mod_Ctrl, Key_D }, [this](auto&) {
    ...
    auto link_default_action = GUI::Action::create("&Open"_string, g_icon_bag.go_to, [this](auto&) {
    ...
    m_link_context_menu->add_action(GUI::Action::create("Open in New &Tab"_string, g_icon_bag.new_tab, [this](auto&) {
        view().on_link_click(m_link_context_menu_url, "_blank", 0);
    }));
    m_link_context_menu->add_separator();
    m_link_context_menu->add_action(GUI::Action::create("&Copy URL"_string, g_icon_bag.copy, [this](auto&) {
        GUI::Clipboard::the().set_plain_text(m_link_context_menu_url.to_deprecated_string());
    }));
    m_link_context_menu->add_separator();
    m_link_context_menu->add_action(GUI::Action::create("&Download"_string, g_icon_bag.download, [this](auto&) {
    ...
    m_image_context_menu->add_action(GUI::Action::create("&Open Image"_string, g_icon_bag.filetype_image, [this](auto&) {
        view().on_link_click(m_image_context_menu_url, "", 0);
    }));
    m_image_context_menu->add_action(GUI::Action::create("Open Image in New &Tab"_string, g_icon_bag.new_tab, [this](auto&) {
        view().on_link_click(m_image_context_menu_url, "_blank", 0);
    }));
    m_image_context_menu->add_separator();
    m_image_context_menu->add_action(GUI::Action::create("&Copy Image"_string, g_icon_bag.copy, [this](auto&) {
        if (m_image_context_menu_bitmap.is_valid())
            GUI::Clipboard::the().set_bitmap(*m_image_context_menu_bitmap.bitmap());
    }));
    m_image_context_menu->add_action(GUI::Action::create("Copy Image &URL"_string, g_icon_bag.copy, [this](auto&) {
        GUI::Clipboard::the().set_plain_text(m_image_context_menu_url.to_deprecated_string());
    }));
    m_image_context_menu->add_separator();
    m_image_context_menu->add_action(GUI::Action::create("&Download"_string, g_icon_bag.download, [this](auto&) {
    ...
    m_media_context_menu_play_pause_action = GUI::Action::create("&Play"_string, g_icon_bag.play, [this](auto&) {
    ...
    m_audio_context_menu->add_action(GUI::Action::create("&Open Audio"_string, g_icon_bag.filetype_audio, [this](auto&) {
        view().on_link_click(m_media_context_menu_url, "", 0);
    }));
    m_audio_context_menu->add_action(GUI::Action::create("Open Audio in New &Tab"_string, g_icon_bag.new_tab, [this](auto&) {
        view().on_link_click(m_media_context_menu_url, "_blank", 0);
    }));
    m_audio_context_menu->add_separator();
    m_audio_context_menu->add_action(GUI::Action::create("Copy Audio &URL"_string, g_icon_bag.copy, [this](auto&) {
        GUI::Clipboard::the().set_plain_text(m_media_context_menu_url.to_deprecated_string());
    }));
    m_audio_context_menu->add_separator();
    m_audio_context_menu->add_action(GUI::Action::create("&Download"_string, g_icon_bag.download, [this](auto&) {
    ...
    m_video_context_menu->add_action(GUI::Action::create("&Open Video"_string, g_icon_bag.filetype_video, [this](auto&) {
        view().on_link_click(m_media_context_menu_url, "", 0);
    }));
    m_video_context_menu->add_action(GUI::Action::create("Open Video in New &Tab"_string, g_icon_bag.new_tab, [this](auto&) {
        view().on_link_click(m_media_context_menu_url, "_blank", 0);
    }));
    m_video_context_menu->add_separator();
    m_video_context_menu->add_action(GUI::Action::create("Copy Video &URL"_string, g_icon_bag.copy, [this](auto&) {
        GUI::Clipboard::the().set_plain_text(m_media_context_menu_url.to_deprecated_string());
    }));
    m_video_context_menu->add_separator();
    m_video_context_menu->add_action(GUI::Action::create("&Download"_string, g_icon_bag.download, [this](auto&) {
        start_download(m_media_context_menu_url);
    }));
    m_video_context_menu->add_separator();
    ...
    auto focus_location_box_action = GUI::Action::create(
        "Focus location box"_string, { Mod_Ctrl, Key_L }, Key_F6, [this](auto&) {
    ...
    m_tab_context_menu->add_action(GUI::Action::create("&Duplicate Tab"_string, g_icon_bag.duplicate_tab, [this](auto&) {
        on_tab_open_request(url());
    }));
    m_tab_context_menu->add_action(GUI::Action::create("Close &Other Tabs"_string, g_icon_bag.close_other_tabs, [this](auto&) {
        on_tab_close_other_request(*this);
    }));

    auto take_visible_screenshot_action = GUI::Action::create(
        "Take &Visible Screenshot"_string, g_icon_bag.filetype_image, [this](auto&) {
    ...
    auto take_full_screenshot_action = GUI::Action::create(
        "Take &Full Screenshot"_string, g_icon_bag.filetype_image, [this](auto&) {
