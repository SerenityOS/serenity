...
StorageWidget::StorageWidget()
{
    ...
    auto delete_cookie_action = GUI::Action::create(
        "&Delete Cookie"_string, { Key_Delete }, Gfx::Bitmap::load_from_file("/res/icons/16x16/delete.png"sv).release_value_but_fixme_should_propagate_errors(), [&](auto const&) {
    ...
    auto delete_all_cookies_action = GUI::Action::create(
        "Delete &All Cookies"_string, [&](auto const&) {
