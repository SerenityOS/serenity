...
ErrorOr<NonnullRefPtr<PlayerWidget>> PlayerWidget::try_create(TrackManager& manager, MainWidget& main_widget, AudioPlayerLoop& loop)
{
    ...
    widget->m_play_icon = TRY(Gfx::Bitmap::load_from_uri("resource://icons/16x16/play.png"sv));
    widget->m_pause_icon = TRY(Gfx::Bitmap::load_from_uri("resource://icons/16x16/pause.png"sv));
    widget->m_back_icon = TRY(Gfx::Bitmap::load_from_uri("resource://icons/16x16/go-back.png"sv));    // Go back a note
    widget->m_next_icon = TRY(Gfx::Bitmap::load_from_uri("resource://icons/16x16/go-forward.png"sv)); // Advance a note
    widget->m_add_track_icon = TRY(Gfx::Bitmap::load_from_uri("resource://icons/16x16/plus.png"sv));
    widget->m_next_track_icon = TRY(Gfx::Bitmap::load_from_uri("resource://icons/16x16/go-last.png"sv));
