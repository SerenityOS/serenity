    ...
    , m_audio_loop(loop)
{
    ...
    m_play_icon = Gfx::Bitmap::try_request_resource("play").release_value_but_fixme_should_propagate_errors();
    m_pause_icon = Gfx::Bitmap::try_request_resource("pause").release_value_but_fixme_should_propagate_errors();
    m_back_icon = Gfx::Bitmap::try_request_resource("go-back").release_value_but_fixme_should_propagate_errors();    // Go back a note
    m_next_icon = Gfx::Bitmap::try_request_resource("go-forward").release_value_but_fixme_should_propagate_errors(); // Advance a note
    m_add_track_icon = Gfx::Bitmap::try_request_resource("plus").release_value_but_fixme_should_propagate_errors();
    m_next_track_icon = Gfx::Bitmap::try_request_resource("go-last").release_value_but_fixme_should_propagate_errors();
