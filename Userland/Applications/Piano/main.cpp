...
ErrorOr<int> serenity_main(Main::Arguments arguments)
{
    ...
    file_menu->add_action(GUI::Action::create("Export...", { Mod_Ctrl, Key_E }, TRY(Media::ImageDecoder::load_from_file("/res/icons/16x16/file-export.png"sv)), [&](const GUI::Action&) {
