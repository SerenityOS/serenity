...
ErrorOr<int> serenity_main(Main::Arguments arguments)
{
    ...
    TRY(file_menu->try_add_action(GUI::Action::create(TRY("Export..."_string), { Mod_Ctrl, Key_E }, TRY(Gfx::Bitmap::load_from_file("/res/icons/16x16/file-export.png"sv)), [&](const GUI::Action&) {
    ...
    TRY(help_menu->try_add_action(GUI::CommonActions::make_about_action(TRY("Piano"_string), app_icon, window)));
