    ...
    , m_window(window)
{
    ...
    m_stop_icon = Gfx::Bitmap::try_request_resource("stop").release_value_but_fixme_should_propagate_errors();
    m_back_icon = Gfx::Bitmap::try_request_resource("go-back").release_value_but_fixme_should_propagate_errors();
    m_next_icon = Gfx::Bitmap::try_request_resource("go-forward").release_value_but_fixme_should_propagate_errors();
