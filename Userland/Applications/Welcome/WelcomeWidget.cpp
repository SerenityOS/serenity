...
WelcomeWidget::WelcomeWidget()
{
    ...
    light_bulb_label.set_icon(Gfx::Bitmap::try_request_resource("app-welcome").release_value_but_fixme_should_propagate_errors());
    ...
    m_next_button->set_icon(Gfx::Bitmap::try_request_resource("go-forward").release_value_but_fixme_should_propagate_errors());
    ...
    m_help_button->set_icon(Gfx::Bitmap::try_request_resource("book-open").release_value_but_fixme_should_propagate_errors());
