...
CharacterMapWidget::CharacterMapWidget()
{
    ...
    m_choose_font_action = GUI::Action::create("Choose Font...", Gfx::Bitmap::try_request_resource("app-font-editor").release_value_but_fixme_should_propagate_errors(), [&](auto&) {
    ...
    m_previous_glyph_action = GUI::Action::create("Previous character", { Mod_Alt, Key_Left }, Gfx::Bitmap::try_request_resource("go-back").release_value_but_fixme_should_propagate_errors(), [&](auto&) {
    ...
    m_find_glyphs_action = GUI::Action::create("&Find glyphs...", { Mod_Ctrl, Key_F }, Gfx::Bitmap::try_request_resource("find").release_value_but_fixme_should_propagate_errors(), [&](auto&) {
