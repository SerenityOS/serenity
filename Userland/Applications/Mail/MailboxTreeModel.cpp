...
{
    m_mail_icon.set_bitmap_for_size(16, Gfx::Bitmap::try_request_resource("app-mail").release_value_but_fixme_should_propagate_errors());
    m_folder_icon.set_bitmap_for_size(16, Gfx::Bitmap::try_request_resource("filetype-folder").release_value_but_fixme_should_propagate_errors());
    m_account_icon.set_bitmap_for_size(16, Gfx::Bitmap::try_request_resource("home-directory").release_value_but_fixme_should_propagate_errors());
}
