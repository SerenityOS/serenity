...
ErrorOr<void> VideoPlayerWidget::initialize()
{
    ...
    m_cycle_sizing_modes_action = GUI::Action::create(
        "Sizing", TRY(Gfx::Bitmap::load_from_uri("resource://icons/16x16/fit-image-to-view.png"sv)), [&](auto&) {
            cycle_sizing_modes();
        });
...
ErrorOr<void> VideoPlayerWidget::initialize_menubar(GUI::Window& window)
{
    ...
    sizing_mode_menu->set_icon(TRY(Gfx::Bitmap::load_from_uri("resource://icons/16x16/fit-image-to-view.png"sv)));
