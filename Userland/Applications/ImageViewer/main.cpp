...
ErrorOr<int> serenity_main(Main::Arguments arguments)
{
    ...
    auto desktop_wallpaper_action = GUI::Action::create("Set as Desktop &Wallpaper", TRY(Gfx::Bitmap::load_from_uri("resource://icons/16x16/app-display-settings.png"sv)),
        [&](auto&) {
    ...
    auto fit_image_to_view_action = GUI::Action::create(
        "Fit Image To &View", TRY(Gfx::Bitmap::load_from_uri("resource://icons/16x16/fit-image-to-view.png"sv)), [&](auto&) {
    ...
    scaling_mode_menu->set_icon(TRY(Gfx::Bitmap::load_from_uri("resource://icons/16x16/scale.png"sv)));
