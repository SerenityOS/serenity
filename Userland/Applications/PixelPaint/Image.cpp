...
ErrorOr<void> Image::export_bmp_to_file(NonnullOwnPtr<Core::Stream> stream, bool preserve_alpha_channel) const
{
...
ErrorOr<void> Image::export_png_to_file(NonnullOwnPtr<Core::Stream> stream, bool preserve_alpha_channel) const
{
    auto bitmap_format = preserve_alpha_channel ? Gfx::BitmapFormat::BGRA8888 : Gfx::BitmapFormat::BGRx8888;
    auto bitmap = TRY(compose_bitmap(bitmap_format));
...
ErrorOr<void> Image::export_qoi_to_file(NonnullOwnPtr<Core::Stream> stream) const
{
