...
void GuideTool::on_context_menu(Layer*, GUI::ContextMenuEvent& event)
{
    ...
    if (!m_context_menu) {
        ...
        m_context_menu->add_action(GUI::Action::create(
            "Set &Offset", MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/gear.png"sv)), [this](auto&) {
            ...
            editor()));
        m_context_menu->add_action(GUI::Action::create(
            "&Delete Guide", MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/delete.png"sv)), [this](auto&) {
                if (!m_context_menu_guide)
                    return;
