...
void CloneTool::draw_point(Gfx::Bitmap& bitmap, Gfx::Color const&, Gfx::IntPoint point)
{
...
void CloneTool::draw_line(Gfx::Bitmap& bitmap, Gfx::Color const& color, Gfx::IntPoint start, Gfx::IntPoint end)
{
    if (!m_sample_location.has_value())
        return;
