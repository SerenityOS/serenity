...
void PenTool::draw_point(Gfx::Bitmap& bitmap, Gfx::Color const& color, Gfx::IntPoint point)
{
    GUI::Painter painter(bitmap);
    painter.draw_line(point, point, color, size());
}

void PenTool::draw_line(Gfx::Bitmap& bitmap, Gfx::Color const& color, Gfx::IntPoint start, Gfx::IntPoint end)
{
    GUI::Painter painter(bitmap);
