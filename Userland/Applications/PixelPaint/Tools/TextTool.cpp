...
ErrorOr<GUI::Widget*> TextTool::get_properties_widget()
{
    ...
    m_font_label = TRY(properties_widget->try_add<GUI::Label>(TRY(String::from_utf8(m_selected_font->human_readable_name()))));
    ...
    change_font_button->on_click = [this](auto) {
        ...
        if (picker->exec() == GUI::Dialog::ExecResult::OK) {
            m_font_label->set_text(String::from_utf8(picker->font()->human_readable_name()).release_value_but_fixme_should_propagate_errors());
