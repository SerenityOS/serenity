...
public:
    ...
    ErrorOr<void> export_bmp_to_file(NonnullOwnPtr<Core::Stream>, bool preserve_alpha_channel) const;
    ErrorOr<void> export_png_to_file(NonnullOwnPtr<Core::Stream>, bool preserve_alpha_channel) const;
    ErrorOr<void> export_qoi_to_file(NonnullOwnPtr<Core::Stream>) const;
