...
{
    auto file = TRY(Core::Stream::File::open("/sys/kernel/variables/caps_lock_to_ctrl"sv, Core::Stream::OpenMode::Read));
    auto buffer = TRY(file->read_until_eof());
    DeprecatedString contents_string((char const*)buffer.data(), buffer.size(), Chomp);
