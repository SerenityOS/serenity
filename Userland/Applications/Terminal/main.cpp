...
ErrorOr<int> serenity_main(Main::Arguments arguments)
{
    ...
    auto open_settings_action = GUI::Action::create("Terminal &Settings"_string, TRY(Gfx::Bitmap::load_from_file("/res/icons/16x16/settings.png"sv)),
        [&](auto&) {
    ...
    file_menu->add_action(GUI::Action::create("Open New &Terminal"_string, { Mod_Ctrl | Mod_Shift, Key_N }, TRY(Gfx::Bitmap::load_from_file("/res/icons/16x16/app-terminal.png"sv)), [&](auto&) {
    ...
    edit_menu->add_action(GUI::Action::create("&Find..."_string, { Mod_Ctrl | Mod_Shift, Key_F }, TRY(Gfx::Bitmap::load_from_file("/res/icons/16x16/find.png"sv)),
        [&](auto&) {
            find_window->show();
