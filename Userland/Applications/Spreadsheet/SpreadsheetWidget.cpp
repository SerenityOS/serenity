    ...
    : m_workbook(make<Workbook>(move(sheets), parent_window))
{
    ...
    help_button.set_icon(MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/app-help.png"sv)));
    ...
    m_tab_context_menu->add_action(GUI::Action::create("Add New Sheet...", MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/new-tab.png"sv)), [this](auto&) {
        String name;
        auto icon = MUST(Gfx::Bitmap::load_from_uri("resource://icons/32x32/filetype-spreadsheet.png"sv));
    ...
    m_new_action = GUI::Action::create("Add New Sheet", MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/new-tab.png"sv)), [&](auto&) {
        add_sheet();
    });
    ...
    m_functions_help_action = GUI::Action::create(
        "&Functions Help", MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/app-help.png"sv)), [&](auto&) {
