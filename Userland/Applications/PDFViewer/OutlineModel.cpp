...
OutlineModel::OutlineModel(const NonnullRefPtr<PDF::OutlineDict>& outline)
    : m_outline(outline)
{
    m_closed_item_icon.set_bitmap_for_size(16, Gfx::Bitmap::try_request_resource("book").release_value_but_fixme_should_propagate_errors());
    m_open_item_icon.set_bitmap_for_size(16, Gfx::Bitmap::try_request_resource("book-open").release_value_but_fixme_should_propagate_errors());
}
