...
void PDFViewerWidget::create_toolbar()
{
    ...
    auto open_outline_action = GUI::Action::create(
        "Toggle &Sidebar", { Mod_Ctrl, Key_S }, Gfx::Bitmap::try_request_resource("sidebar").release_value_but_fixme_should_propagate_errors(), [&](auto&) {
    ...
    m_go_to_prev_page_action = GUI::Action::create("Go to &Previous Page", Gfx::Bitmap::try_request_resource("go-up").release_value_but_fixme_should_propagate_errors(), [&](auto&) {
    ...
    m_go_to_next_page_action = GUI::Action::create("Go to &Next Page", Gfx::Bitmap::try_request_resource("go-down").release_value_but_fixme_should_propagate_errors(), [&](auto&) {
