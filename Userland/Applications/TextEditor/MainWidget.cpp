...
MainWidget::MainWidget()
{
    ...
    m_find_next_action = GUI::Action::create("Find &Next"_string, { Mod_Ctrl, Key_G }, Gfx::Bitmap::load_from_file("/res/icons/16x16/find-next.png"sv).release_value_but_fixme_should_propagate_errors(), [this](auto&) {
        find_text(GUI::TextEditor::SearchDirection::Forward, ShowMessageIfNoResults::Yes);
    });

    m_find_previous_action = GUI::Action::create("Find Pr&evious"_string, { Mod_Ctrl | Mod_Shift, Key_G }, Gfx::Bitmap::load_from_file("/res/icons/16x16/find-previous.png"sv).release_value_but_fixme_should_propagate_errors(), [this](auto&) {
        find_text(GUI::TextEditor::SearchDirection::Backward, ShowMessageIfNoResults::Yes);
    });

    m_replace_action = GUI::Action::create("Rep&lace"_string, { Mod_Ctrl, Key_F1 }, [&](auto&) {
    ...
    m_replace_all_action = GUI::Action::create("Replace &All"_string, { Mod_Ctrl, Key_F2 }, [&](auto&) {
        auto needle = m_find_textbox->text();
        auto substitute = m_replace_textbox->text();
    ...
    m_vim_emulation_setting_action = GUI::Action::create_checkable("&Vim Emulation"_string, { Mod_Ctrl | Mod_Shift | Mod_Alt, Key_V }, [&](auto& action) {
    ...
    m_find_replace_action = GUI::Action::create("&Find/Replace..."_string, { Mod_Ctrl | Mod_Shift, Key_F }, Gfx::Bitmap::load_from_file("/res/icons/16x16/find.png"sv).release_value_but_fixme_should_propagate_errors(), [this](auto&) {
    ...
    m_new_action = GUI::Action::create("&New"_string, { Mod_Ctrl, Key_N }, Gfx::Bitmap::load_from_file("/res/icons/16x16/new.png"sv).release_value_but_fixme_should_propagate_errors(), [this](GUI::Action const&) {
    ...
    m_open_folder_action = GUI::Action::create("Reveal in File Manager"_string, { Mod_Ctrl | Mod_Shift, Key_O }, file_manager_icon, [&](auto&) {
...
ErrorOr<void> MainWidget::initialize_menubar(GUI::Window& window)
{
    ...
    m_layout_statusbar_action = GUI::Action::create_checkable("&Status Bar"_string, [&](auto& action) {
    ...
    m_layout_ruler_action = GUI::Action::create_checkable("&Ruler"_string, [&](auto& action) {
    ...
    view_menu->add_action(GUI::Action::create("Change &Font..."_string, TRY(Gfx::Bitmap::load_from_file("/res/icons/16x16/app-font-editor.png"sv)),
        [&](auto&) {
    ...
    m_soft_tab_1_width_action = GUI::Action::create_checkable("1"_string, [&](auto&) {
        m_editor->set_soft_tab_width(1);
    });
    m_soft_tab_2_width_action = GUI::Action::create_checkable("2"_string, [&](auto&) {
        m_editor->set_soft_tab_width(2);
    });
    m_soft_tab_4_width_action = GUI::Action::create_checkable("4"_string, [&](auto&) {
        m_editor->set_soft_tab_width(4);
    });
    m_soft_tab_8_width_action = GUI::Action::create_checkable("8"_string, [&](auto&) {
        m_editor->set_soft_tab_width(8);
    });
    m_soft_tab_16_width_action = GUI::Action::create_checkable("16"_string, [&](auto&) {
    ...
    m_visualize_trailing_whitespace_action = GUI::Action::create_checkable("T&railing Whitespace"_string, [&](auto&) {
        m_editor->set_visualize_trailing_whitespace(m_visualize_trailing_whitespace_action->is_checked());
    });
    m_visualize_leading_whitespace_action = GUI::Action::create_checkable("L&eading Whitespace"_string, [&](auto&) {
    ...
    m_cursor_line_highlighting_action = GUI::Action::create_checkable("L&ine Highlighting"_string, [&](auto&) {
    ...
    m_relative_line_number_action = GUI::Action::create_checkable("R&elative Line Number"_string, [&](auto& action) {
    ...
    m_plain_text_highlight = GUI::Action::create_checkable("&Plain Text"_string, [&](auto&) {
    ...
    m_cpp_highlight = GUI::Action::create_checkable("&C++"_string, [&](auto&) {
    ...
    m_cmake_highlight = GUI::Action::create_checkable("C&Make"_string, [&](auto&) {
    ...
    m_cmakecache_highlight = GUI::Action::create_checkable("CM&akeCache"_string, [&](auto&) {
    ...
    m_js_highlight = GUI::Action::create_checkable("&JavaScript"_string, [&](auto&) {
    ...
    m_css_highlight = GUI::Action::create_checkable("C&SS"_string, [&](auto&) {
    ...
    m_html_highlight = GUI::Action::create_checkable("&HTML File"_string, [&](auto&) {
    ...
    m_git_highlight = GUI::Action::create_checkable("Gi&t Commit"_string, [&](auto&) {
    ...
    m_gml_highlight = GUI::Action::create_checkable("&GML"_string, [&](auto&) {
    ...
    m_ini_highlight = GUI::Action::create_checkable("&INI File"_string, [&](auto&) {
    ...
    m_markdown_highlight = GUI::Action::create_checkable("Ma&rkdown"_string, [&](auto&) {
    ...
    m_shell_highlight = GUI::Action::create_checkable("Sh&ell File"_string, [&](auto&) {
    ...
    m_sql_highlight = GUI::Action::create_checkable("S&QL File"_string, [&](auto&) {
