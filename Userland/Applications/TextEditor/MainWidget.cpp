...
MainWidget::MainWidget()
{
    ...
    m_find_next_action = GUI::Action::create("Find &Next", { Mod_Ctrl, Key_G }, Media::ImageDecoder::load_from_file("/res/icons/16x16/find-next.png"sv).release_value_but_fixme_should_propagate_errors(), [this](auto&) {
        find_text(GUI::TextEditor::SearchDirection::Forward, ShowMessageIfNoResults::Yes);
    });

    m_find_previous_action = GUI::Action::create("Find Pr&evious", { Mod_Ctrl | Mod_Shift, Key_G }, Media::ImageDecoder::load_from_file("/res/icons/16x16/find-previous.png"sv).release_value_but_fixme_should_propagate_errors(), [this](auto&) {
    ...
    m_find_previous_button->set_icon(Media::ImageDecoder::load_from_file("/res/icons/16x16/find-previous.png"sv).release_value_but_fixme_should_propagate_errors());
    ...
    m_find_next_button->set_icon(Media::ImageDecoder::load_from_file("/res/icons/16x16/find-next.png"sv).release_value_but_fixme_should_propagate_errors());
    ...
    m_find_replace_action = GUI::Action::create("&Find/Replace...", { Mod_Ctrl | Mod_Shift, Key_F }, Media::ImageDecoder::load_from_file("/res/icons/16x16/find.png"sv).release_value_but_fixme_should_propagate_errors(), [this](auto&) {
    ...
    m_new_action = GUI::Action::create("&New", { Mod_Ctrl, Key_N }, Media::ImageDecoder::load_from_file("/res/icons/16x16/new.png"sv).release_value_but_fixme_should_propagate_errors(), [this](GUI::Action const&) {
    ...
    auto file_manager_icon = Media::ImageDecoder::load_from_file("/res/icons/16x16/app-file-manager.png"sv).release_value_but_fixme_should_propagate_errors();
...
ErrorOr<void> MainWidget::initialize_menubar(GUI::Window& window)
{
    ...
    view_menu->add_action(GUI::Action::create("Change &Font...", TRY(Media::ImageDecoder::load_from_file("/res/icons/16x16/app-font-editor.png"sv)),
        [&](auto&) {
