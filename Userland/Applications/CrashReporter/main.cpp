...
ErrorOr<int> serenity_main(Main::Arguments arguments)
{
    ...
    TRY(args_parser.add_positional_argument(coredump_path, "Coredump path", "coredump-path"));
    TRY(args_parser.add_option(unlink_on_exit, "Delete the coredump after its parsed", "unlink", 0));
