...
ErrorOr<int> serenity_main(Main::Arguments arguments)
{
    ...
    debug_button.set_icon(TRY(Gfx::Bitmap::load_from_uri("resource://icons/16x16/app-hack-studio.png"sv)));
    ...
    save_backtrace_button.set_icon(TRY(Gfx::Bitmap::load_from_uri("resource://icons/16x16/save.png"sv)));
