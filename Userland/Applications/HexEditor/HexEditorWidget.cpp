...
ErrorOr<void> HexEditorWidget::setup()
{
    ...
    m_search_results->on_activation = [this](GUI::ModelIndex const& index) {
        if (!index.is_valid())
            return;
    ...
    m_fill_selection_action = GUI::Action::create("Fill &Selection...", { Mod_Ctrl, Key_B }, [&](GUI::Action const&) {
        String value;
