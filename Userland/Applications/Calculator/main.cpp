...
ErrorOr<int> serenity_main(Main::Arguments arguments)
{
    ...
    constants_menu->add_action(GUI::Action::create("&Pi"_string, TRY(Gfx::Bitmap::load_from_file("/res/icons/calculator/pi.png"sv)), [&](auto&) {
        widget->set_typed_entry(Crypto::BigFraction { Crypto::SignedBigInteger(31415926535), power });
    }));
    constants_menu->add_action(GUI::Action::create("&Euler's Number"_string, TRY(Gfx::Bitmap::load_from_file("/res/icons/calculator/eulers_number.png"sv)), [&](auto&) {
        widget->set_typed_entry(Crypto::BigFraction { Crypto::SignedBigInteger(27182818284), power });
    }));
    constants_menu->add_action(GUI::Action::create("&Phi"_string, TRY(Gfx::Bitmap::load_from_file("/res/icons/calculator/phi.png"sv)), [&](auto&) {
    ...
    auto shrink_action = GUI::Action::create("&Shrink..."_string, TRY(Gfx::Bitmap::load_from_file("/res/icons/16x16/edit-cut.png"sv)), [&](auto&) {
