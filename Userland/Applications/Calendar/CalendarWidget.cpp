...
{
    return GUI::Action::create("&New Calendar", {}, TRY(Gfx::Bitmap::load_from_uri("resource://icons/16x16/app-calendar.png"sv)), [&](GUI::Action const&) {
...
{
    return GUI::Action::create({}, TRY(Gfx::Bitmap::load_from_uri("resource://icons/16x16/go-back.png"sv)), [&](GUI::Action const&) {
...
{
    return GUI::Action::create({}, TRY(Gfx::Bitmap::load_from_uri("resource://icons/16x16/go-forward.png"sv)), [&](GUI::Action const&) {
...
{
    return GUI::Action::create("&Add Event", {}, TRY(Gfx::Bitmap::load_from_uri("resource://icons/16x16/add-event.png"sv)), [&](GUI::Action const&) {
...
{
    return GUI::Action::create("Jump to &Today", {}, TRY(Gfx::Bitmap::load_from_uri("resource://icons/16x16/calendar-date.png"sv)), [&](GUI::Action const&) {
...
{
    return GUI::Action::create("Calendar &Settings", {}, TRY(Gfx::Bitmap::load_from_uri("resource://icons/16x16/app-settings.png"sv)), [&](GUI::Action const&) {
