...
NetworkStatisticsWidget::NetworkStatisticsWidget()
{
    on_first_show = [this](auto&) {
        ...
        net_adapters_fields.empend("", Gfx::Alignment::CenterLeft,
        ...
        net_adapters_fields.empend("name", "Name", Gfx::Alignment::CenterLeft);
        net_adapters_fields.empend("class_name", "Class", Gfx::Alignment::CenterLeft);
        net_adapters_fields.empend("mac_address", "MAC", Gfx::Alignment::CenterLeft);
        net_adapters_fields.empend("Link status", Gfx::Alignment::CenterLeft,
        ...
        net_adapters_fields.empend("IPv4", Gfx::Alignment::CenterLeft,
            [](JsonObject const& object) -> String {
                return object.get("ipv4_address").as_string_or("");
            });
        net_adapters_fields.empend("packets_in", "Pkt In", Gfx::Alignment::CenterRight);
        net_adapters_fields.empend("packets_out", "Pkt Out", Gfx::Alignment::CenterRight);
        net_adapters_fields.empend("bytes_in", "Bytes In", Gfx::Alignment::CenterRight);
        net_adapters_fields.empend("bytes_out", "Bytes Out", Gfx::Alignment::CenterRight);
        ...
        net_tcp_fields.empend("peer_address", "Peer", Gfx::Alignment::CenterLeft);
        net_tcp_fields.empend("peer_port", "Port", Gfx::Alignment::CenterRight);
        net_tcp_fields.empend("local_address", "Local", Gfx::Alignment::CenterLeft);
        net_tcp_fields.empend("local_port", "Port", Gfx::Alignment::CenterRight);
        net_tcp_fields.empend("state", "State", Gfx::Alignment::CenterLeft);
        net_tcp_fields.empend("ack_number", "Ack#", Gfx::Alignment::CenterRight);
        net_tcp_fields.empend("sequence_number", "Seq#", Gfx::Alignment::CenterRight);
        net_tcp_fields.empend("packets_in", "Pkt In", Gfx::Alignment::CenterRight);
        net_tcp_fields.empend("packets_out", "Pkt Out", Gfx::Alignment::CenterRight);
        net_tcp_fields.empend("bytes_in", "Bytes In", Gfx::Alignment::CenterRight);
        net_tcp_fields.empend("bytes_out", "Bytes Out", Gfx::Alignment::CenterRight);
        ...
        net_udp_fields.empend("peer_address", "Peer", Gfx::Alignment::CenterLeft);
        net_udp_fields.empend("peer_port", "Port", Gfx::Alignment::CenterRight);
        net_udp_fields.empend("local_address", "Local", Gfx::Alignment::CenterLeft);
        net_udp_fields.empend("local_port", "Port", Gfx::Alignment::CenterRight);
