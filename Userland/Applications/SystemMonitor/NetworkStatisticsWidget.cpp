...
NetworkStatisticsWidget::NetworkStatisticsWidget()
{
    on_first_show = [this](auto&) {
        ...
        m_network_connected_bitmap = Gfx::Bitmap::try_request_resource("network-connected").release_value_but_fixme_should_propagate_errors();
        m_network_disconnected_bitmap = Gfx::Bitmap::try_request_resource("network-disconnected").release_value_but_fixme_should_propagate_errors();
