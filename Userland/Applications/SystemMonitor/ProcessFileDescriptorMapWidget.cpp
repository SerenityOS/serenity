...
ProcessFileDescriptorMapWidget::ProcessFileDescriptorMapWidget()
{
    ...
    pid_fds_fields.empend("fd", "FD", Gfx::Alignment::CenterRight);
    pid_fds_fields.empend("class", "Class", Gfx::Alignment::CenterLeft);
    pid_fds_fields.empend("offset", "Offset", Gfx::Alignment::CenterRight);
    pid_fds_fields.empend("absolute_path", "Path", Gfx::Alignment::CenterLeft);
    pid_fds_fields.empend("Access", Gfx::Alignment::CenterLeft, [](auto& object) {
        return object.get("seekable").to_bool() ? "Seekable" : "Sequential";
    });
    pid_fds_fields.empend("Blocking", Gfx::Alignment::CenterLeft, [](auto& object) {
        return object.get("blocking").to_bool() ? "Blocking" : "Nonblocking";
    });
    pid_fds_fields.empend("On exec", Gfx::Alignment::CenterLeft, [](auto& object) {
        return object.get("cloexec").to_bool() ? "Close" : "Keep";
    });
    pid_fds_fields.empend("Can read", Gfx::Alignment::CenterLeft, [](auto& object) {
        return object.get("can_read").to_bool() ? "Yes" : "No";
    });
    pid_fds_fields.empend("Can write", Gfx::Alignment::CenterLeft, [](auto& object) {
