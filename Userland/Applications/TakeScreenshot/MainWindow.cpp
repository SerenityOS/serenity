...
{
    auto app_icon = GUI::Icon::default_icon("app-take-screenshot"sv);

    set_title("Take Screenshot");
    set_icon(app_icon.bitmap_for_size(16));
    resize(300, 150);
    set_resizable(false);
    set_minimizable(false);

    auto main_widget = MUST(TakeScreenshot::MainWidget::try_create());
    ...
    m_destination->set_text(Core::StandardPaths::pictures_directory());
}
