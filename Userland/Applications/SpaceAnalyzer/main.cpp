...
ErrorOr<int> serenity_main(Main::Arguments arguments)
{
    ...
    file_menu->add_action(GUI::Action::create("&Analyze"_string, { KeyCode::Key_F5 }, TRY(Gfx::Bitmap::load_from_file("/res/icons/16x16/reload.png"sv)), [&](auto&) {
    ...
    auto open_action = GUI::Action::create("Open in File Manager"_string, { Mod_Ctrl, Key_O }, open_icon, [&](auto&) {
    ...
    auto copy_path_action = GUI::Action::create("Copy Path to Clipboard"_string, { Mod_Ctrl, Key_C }, copy_icon, [&](auto&) {
