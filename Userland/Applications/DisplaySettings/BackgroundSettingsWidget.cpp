...
void BackgroundSettingsWidget::create_frame()
{
    ...
    m_show_in_file_manager_action = GUI::Action::create("Show in File Manager", Gfx::Bitmap::try_request_resource("app-file-manager").release_value_but_fixme_should_propagate_errors(), [this](GUI::Action const&) {
