...
{
    m_section_open_icon.set_bitmap_for_size(16, Gfx::Bitmap::try_request_resource("book-open").release_value_but_fixme_should_propagate_errors());
    m_section_icon.set_bitmap_for_size(16, Gfx::Bitmap::try_request_resource("book").release_value_but_fixme_should_propagate_errors());
    m_page_icon.set_bitmap_for_size(16, Gfx::Bitmap::try_request_resource("filetype-unknown").release_value_but_fixme_should_propagate_errors());
}
