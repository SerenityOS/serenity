...
{
    m_section_open_icon.set_bitmap_for_size(16, MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/book-open.png"sv)));
    m_section_icon.set_bitmap_for_size(16, MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/book.png"sv)));
    m_page_icon.set_bitmap_for_size(16, MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/filetype-unknown.png"sv)));
}
