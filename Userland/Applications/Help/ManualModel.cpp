...
Optional<GUI::ModelIndex> ManualModel::index_from_path(StringView const& path) const
{
...
Result<StringView, OSError> ManualModel::page_view(String const& path) const
{
    if (path.is_empty())
        return StringView {};
