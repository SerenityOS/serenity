...
ErrorOr<void> MainWidget::initialize_fallibles(GUI::Window& window)
{
    ...
    help_menu->add_action(GUI::Action::create("&Contents"_string, { Key_F1 }, TRY(Gfx::Bitmap::load_from_file("/res/icons/16x16/filetype-unknown.png"sv)), [this, help_page_path = move(help_page_path)](auto&) {
