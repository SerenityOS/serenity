...
ErrorOr<void> MainWidget::initialize(GUI::Window& window)
{
    ...
    help_menu->add_action(GUI::Action::create("&Contents", { Key_F1 }, TRY(Gfx::Bitmap::load_from_uri("resource://icons/16x16/filetype-unknown.png"sv)), [this, help_page_path = move(help_page_path)](auto&) {
