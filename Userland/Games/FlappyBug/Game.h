...
public:
    ...
    public:
        ...
        {
            NonnullRefPtr<Gfx::Bitmap> falling_bitmap = TRY(Gfx::Bitmap::try_request_resource("falling"));
            NonnullRefPtr<Gfx::Bitmap> flapping_bitmap = TRY(Gfx::Bitmap::try_request_resource("flapping"));
    ...
    public:
        ...
        {
            Vector<NonnullRefPtr<Gfx::Bitmap>> const cloud_bitmaps {
                TRY(Gfx::Bitmap::try_request_resource("cloud_0")),
                TRY(Gfx::Bitmap::try_request_resource("cloud_1")),
                TRY(Gfx::Bitmap::try_request_resource("cloud_2")),
            };
...
private:
    ...
    NonnullRefPtr<Gfx::Bitmap> m_background_bitmap { Gfx::Bitmap::try_request_resource("background").release_value_but_fixme_should_propagate_errors() };
