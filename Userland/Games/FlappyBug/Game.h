...
public:
    ...
    public:
        ...
        {
            NonnullRefPtr<Gfx::Bitmap> falling_bitmap = TRY(Media::ImageDecoder::load_from_file("/res/graphics/flappybug/falling.png"sv));
            NonnullRefPtr<Gfx::Bitmap> flapping_bitmap = TRY(Media::ImageDecoder::load_from_file("/res/graphics/flappybug/flapping.png"sv));
    ...
    public:
        ...
        {
            Vector<NonnullRefPtr<Gfx::Bitmap>> const cloud_bitmaps {
                TRY(Media::ImageDecoder::load_from_file("/res/graphics/flappybug/cloud_0.png"sv)),
                TRY(Media::ImageDecoder::load_from_file("/res/graphics/flappybug/cloud_1.png"sv)),
                TRY(Media::ImageDecoder::load_from_file("/res/graphics/flappybug/cloud_2.png"sv)),
            };
...
private:
    ...
    NonnullRefPtr<Gfx::Bitmap> m_background_bitmap { Media::ImageDecoder::load_from_file("/res/graphics/flappybug/background.png"sv).release_value_but_fixme_should_propagate_errors() };
