...
public:
    ...
    public:
        ...
        {
            NonnullRefPtr<Gfx::Bitmap> falling_bitmap = TRY(Gfx::Bitmap::load_from_uri("resource://graphics/flappybug/falling.png"sv));
            NonnullRefPtr<Gfx::Bitmap> flapping_bitmap = TRY(Gfx::Bitmap::load_from_uri("resource://graphics/flappybug/flapping.png"sv));
    ...
    public:
        ...
        {
            Vector<NonnullRefPtr<Gfx::Bitmap>> const cloud_bitmaps {
                TRY(Gfx::Bitmap::load_from_uri("resource://graphics/flappybug/cloud_0.png"sv)),
                TRY(Gfx::Bitmap::load_from_uri("resource://graphics/flappybug/cloud_1.png"sv)),
                TRY(Gfx::Bitmap::load_from_uri("resource://graphics/flappybug/cloud_2.png"sv)),
            };
...
private:
    ...
    NonnullRefPtr<Gfx::Bitmap> m_background_bitmap { Gfx::Bitmap::load_from_uri("resource://graphics/flappybug/background.png"sv).release_value() };
