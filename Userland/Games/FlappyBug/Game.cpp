...
void Game::paint_event(GUI::PaintEvent& event)
{
    ...
    if (m_active) {
        painter.draw_text(m_score_rect, String::formatted("{:.0}", m_difficulty), Gfx::Alignment::TopLeft, Color::White);
        ...
        painter.draw_text(m_text_rect, message, Gfx::Alignment::Center, Color::White);
    } else {
        painter.draw_text(m_text_rect, "Press any key to start", Gfx::Alignment::Center, Color::White);
    }
}
