...
ErrorOr<int> serenity_main(Main::Arguments arguments)
{
    ...
    TRY(game_menu->try_add_action(GUI::Action::create("&New Game", { Mod_None, Key_F2 }, TRY(Gfx::Bitmap::try_request_resource("reload")), [&](auto&) {
        start_a_new_game();
    })));
    ...
    TRY(game_menu->try_add_action(GUI::Action::create("&Settings...", TRY(Gfx::Bitmap::try_request_resource("settings")), [&](auto&) {
        change_settings();
    })));
