...
public:
    static ErrorOr<NonnullRefPtr<AudioWidget>> try_create()
    {
        Array<VolumeBitmapPair, 5> volume_level_bitmaps = {
            { { 66, TRY(Gfx::Bitmap::load_from_uri("resource://icons/16x16/audio-volume-high.png"sv)) },
                { 33, TRY(Gfx::Bitmap::load_from_uri("resource://icons/16x16/audio-volume-medium.png"sv)) },
                { 1, TRY(Gfx::Bitmap::load_from_uri("resource://icons/16x16/audio-volume-low.png"sv)) },
                { 0, TRY(Gfx::Bitmap::load_from_uri("resource://icons/16x16/audio-volume-zero.png"sv)) },
                { 0, TRY(Gfx::Bitmap::load_from_uri("resource://icons/16x16/audio-volume-muted.png"sv)) } }
        };
