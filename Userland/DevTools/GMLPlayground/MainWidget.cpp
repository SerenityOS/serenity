...
ErrorOr<void> MainWidget::initialize_menubar(GUI::Window& window)
{
    ...
    auto format_gml_action = GUI::Action::create("&Format GML"_string, { Mod_Ctrl | Mod_Shift, Key_I }, TRY(Gfx::Bitmap::load_from_file("/res/icons/16x16/reformat.png"sv)), [&](auto&) {
