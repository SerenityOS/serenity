...
ErrorOr<void> MainWidget::initialize_menubar(GUI::Window& window)
{
    ...
    auto format_gml_action = GUI::Action::create("&Format GML", { Mod_Ctrl | Mod_Shift, Key_I }, TRY(Media::ImageDecoder::load_from_file("/res/icons/16x16/reformat.png"sv)), [&](auto&) {
