...
public:
    ...
    void set_profiling_details(bool should_dump_profile, size_t instruction_interval, Core::Stream* profile_stream, NonnullOwnPtrVector<DeprecatedString>* profiler_strings, Vector<int>* profiler_string_id_map)
    {
    ...
    Core::Stream& profile_stream() { return *m_profile_stream; }
...
private:
    ...
    void emit_profile_sample(Core::Stream&);
    void emit_profile_event(Core::Stream&, StringView event_name, DeprecatedString const& contents);
    ...
    Core::Stream* m_profile_stream { nullptr };
