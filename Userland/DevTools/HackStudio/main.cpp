...
ErrorOr<int> serenity_main(Main::Arguments arguments)
{
    ...
    window->set_icon(Gfx::Bitmap::try_request_resource("app-hack-studio").release_value_but_fixme_should_propagate_errors());
...
static void notify_make_not_available()
{
    ...
    notification->set_icon(Gfx::Bitmap::try_request_resource("app-hack-studio").release_value_but_fixme_should_propagate_errors());
