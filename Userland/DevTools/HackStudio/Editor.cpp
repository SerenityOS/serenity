...
Editor::Editor()
{
    ...
    m_move_execution_to_line_action = GUI::Action::create("Set Execution Point to Cursor Line"_string.release_value_but_fixme_should_propagate_errors(), [this](auto&) {
