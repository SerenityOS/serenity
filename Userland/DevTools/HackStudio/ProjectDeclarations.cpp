...
{
    static GUI::Icon struct_icon(Gfx::Bitmap::try_request_resource("Struct").release_value_but_fixme_should_propagate_errors());
    static GUI::Icon class_icon(Gfx::Bitmap::try_request_resource("Class").release_value_but_fixme_should_propagate_errors());
    static GUI::Icon function_icon(Gfx::Bitmap::try_request_resource("Function").release_value_but_fixme_should_propagate_errors());
    static GUI::Icon variable_icon(Gfx::Bitmap::try_request_resource("Variable").release_value_but_fixme_should_propagate_errors());
    static GUI::Icon preprocessor_icon(Gfx::Bitmap::try_request_resource("Preprocessor").release_value_but_fixme_should_propagate_errors());
    static GUI::Icon member_icon(Gfx::Bitmap::try_request_resource("Member").release_value_but_fixme_should_propagate_errors());
    static GUI::Icon namespace_icon(Gfx::Bitmap::try_request_resource("Namespace").release_value_but_fixme_should_propagate_errors());
    switch (type) {
