...
private:
    ...
    {
        m_variable_icon.set_bitmap_for_size(16, Media::ImageDecoder::load_from_file("/res/icons/16x16/inspector-object.png"sv).release_value_but_fixme_should_propagate_errors());
    }
