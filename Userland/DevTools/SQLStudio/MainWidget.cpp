...
{
    m_new_action = GUI::Action::create("&New"_string, { Mod_Ctrl, Key_N }, TRY(Gfx::Bitmap::load_from_file("/res/icons/16x16/new.png"sv)), [this](auto&) {
        open_new_script();
    });
    ...
    m_save_all_action = GUI::Action::create("Save All"_string, { Mod_Ctrl | Mod_Alt, Key_S }, [this](auto&) {
        auto* editor = active_editor();
        VERIFY(editor);
    ...
    m_connect_to_database_action = GUI::Action::create("Connect to Database"_string, { Mod_Alt, Key_C }, TRY(Gfx::Bitmap::load_from_file("/res/icons/16x16/go-forward.png"sv)), [this](auto&) {
    ...
    m_run_script_action = GUI::Action::create("Run Script"_string, { Mod_Alt, Key_F9 }, TRY(Gfx::Bitmap::load_from_file("/res/icons/16x16/play.png"sv)), [&](auto&) {
        m_results.clear();
