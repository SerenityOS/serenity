...
RemoteObjectGraphModel::RemoteObjectGraphModel(RemoteProcess& process)
    : m_process(process)
{
    m_object_icon.set_bitmap_for_size(16, Gfx::Bitmap::try_request_resource("inspector-object").release_value_but_fixme_should_propagate_errors());
    m_window_icon.set_bitmap_for_size(16, Gfx::Bitmap::try_request_resource("window").release_value_but_fixme_should_propagate_errors());
    m_layout_icon.set_bitmap_for_size(16, Gfx::Bitmap::try_request_resource("layout").release_value_but_fixme_should_propagate_errors());
    m_timer_icon.set_bitmap_for_size(16, Gfx::Bitmap::try_request_resource("timer").release_value_but_fixme_should_propagate_errors());
}
