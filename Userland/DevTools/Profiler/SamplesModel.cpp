...
SamplesModel::SamplesModel(Profile& profile)
    : m_profile(profile)
{
    m_user_frame_icon.set_bitmap_for_size(16, MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/inspector-object.png"sv)));
    m_kernel_frame_icon.set_bitmap_for_size(16, MUST(Gfx::Bitmap::load_from_uri("resource://icons/16x16/inspector-object-red.png"sv)));
}
