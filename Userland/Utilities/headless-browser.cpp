...
public:
    ...
    virtual void page_did_request_link_context_menu(Web::CSSPixelPoint const&, AK::URL const&, String const&, unsigned) override
    {
    }

    virtual void page_did_request_image_context_menu(Web::CSSPixelPoint const&, AK::URL const&, String const&, unsigned, Gfx::Bitmap const*) override
    {
    }
