...
HANDLE(TIOCNOTTY)
HANDLE(TIOCSWINSZ)
HANDLE(GPU_IOCTL_GET_PROPERTIES)
HANDLE(GPU_IOCTL_SET_HEAD_MODE_SETTING)
HANDLE(GPU_IOCTL_GET_HEAD_MODE_SETTING)
HANDLE(GPU_IOCTL_SET_HEAD_VERTICAL_OFFSET_BUFFER)
HANDLE(GPU_IOCTL_GET_HEAD_VERTICAL_OFFSET_BUFFER)
HANDLE(GPU_IOCTL_FLUSH_HEAD_BUFFERS)
HANDLE(GPU_IOCTL_FLUSH_HEAD)
