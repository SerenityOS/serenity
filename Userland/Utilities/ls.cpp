...
ErrorOr<int> serenity_main(Main::Arguments arguments)
{
    ...
    args_parser.add_option(flag_show_almost_all_dotfiles, "Do not list implied . and .. directories", {}, 'A');
    ...
    args_parser.add_option(flag_sort_by, FieldToSortBy::ModifiedAt, "Sort files by timestamp (newest first)", {}, 't');
    args_parser.add_option(flag_sort_by, FieldToSortBy::Size, "Sort files by size (largest first)", {}, 'S');
    ...
    args_parser.add_option(flag_indicator_style, IndicatorStyle::Directory, "Append a '/' indicator to directories", {}, 'p');
    args_parser.add_option(flag_colorize, "Use pretty colors", {}, 'G');
    ...
    args_parser.add_option(flag_hide_group, "In long format, do not show group information. Implies '-l'", {}, 'o');
    args_parser.add_option(flag_hide_owner, "In long format, do not show owner information. Implies '-l'", {}, 'g');
    ...
    args_parser.add_option(flag_force_newline, "List one file per line", {}, '1');
