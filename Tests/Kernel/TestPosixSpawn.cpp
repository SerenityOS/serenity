...
// Helper to spawn with optional spawnattr (nullptr = fast path, non-null = slow path)
...
// Helper to get spawnattr pointer (nullptr for fast path, initialized attr for slow path)
...
// ============================================================================
// ERROR PROPAGATION TESTS (fast path only - kernel returns errors synchronously)
// ============================================================================
