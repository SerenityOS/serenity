...
static constexpr const int iterations = 10;
static constexpr const int seed = 1337;
...
TEST_CASE(sorts_ascending)
{
    ...
    for (int i = 0; i < iterations; ++i) {
        ...
        insertion_sort(ints);
        insertion_sort(ints_copy.begin(), ints_copy.end());
...
TEST_CASE(sorts_decending)
{
    ...
    for (int i = 0; i < iterations; ++i) {
        ...
        insertion_sort(ints_copy.begin(), ints_copy.end(), [](auto& a, auto& b) { return a > b; });
