...
{
    auto file1 = Core::Stream::open(filename1, Core::OpenMode::ReadOnly).value();
    auto file2 = Core::Stream::open(filename2, Core::OpenMode::ReadOnly).value();
...
TEST_CASE(file_readline)
{
    ...
    auto file_or_error = Core::Stream::open(path, Core::OpenMode::ReadOnly);
    ...
    auto outfile_or_error = Core::Stream::open(output_path, Core::OpenMode::WriteOnly);
...
TEST_CASE(file_get_read_position)
{
    ...
    auto file = Core::Stream::open(path, Core::OpenMode::ReadOnly).release_value();
