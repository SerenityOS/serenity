...
TEST_CASE(TEST_1)
{
    ...
    Array<u8, 64> expected_signature = {
    ...
    ed25519_test(public_key, private_key, message, expected_signature);
}
...
TEST_CASE(verify_rejects_inputs_of_the_wrong_size)
{
    // https://datatracker.ietf.org/doc/html/rfc8032#section-7.1
    Array<u8, 32> public_key = {
        0xd7, 0x5a, 0x98, 0x01, 0x82, 0xb1, 0x0a, 0xb7,
    ...
    EXPECT(Crypto::Curves::Ed25519::verify(public_key, signature, message));
    EXPECT(!Crypto::Curves::Ed25519::verify(public_key, signature.span().trim(63), message));
    EXPECT(!Crypto::Curves::Ed25519::verify(public_key.span().trim(31), signature, message));
}
