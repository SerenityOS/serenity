...
static void test_chacha20(ReadonlyBytes key, ReadonlyBytes nonce, u32 initial_block_counter, ReadonlyBytes plaintext, ReadonlyBytes ciphertext)
{
...
TEST_CASE(test_vector_1)
{
    ...
    Array<u8, 64> plaintext = {};
    Array<u8, 64> ciphertext {
    ...
    test_chacha20(key, nonce, initial_block_counter, plaintext, ciphertext);
}
