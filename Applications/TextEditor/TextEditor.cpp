...
TextEditorWidget::TextEditorWidget(GApplication* app, GWindow* window, const int& argc, char** argv)
{
    set_layout(make<GBoxLayout>(Orientation::Vertical));
    layout()->set_spacing(0);

    auto* toolbar = new GToolBar(this);
    auto* text_editor = new GTextEditor(GTextEditor::MultiLine, this);
    ...
    auto open_action = GAction::create("Open document", { Mod_Ctrl, Key_O }, GraphicsBitmap::load_from_file("/res/icons/16x16/open.png"), [window, text_editor, this](const GAction&) {
        GFilePicker picker;
    ...
    auto save_action = GAction::create("Save document", { Mod_Ctrl, Key_S }, GraphicsBitmap::load_from_file("/res/icons/16x16/save.png"), [text_editor, this](const GAction&) {
...
void TextEditorWidget::open_sesame(GWindow* window, GTextEditor* editor, const String& path)
{
