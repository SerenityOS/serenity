...
template<SIMDVector T, SIMDVector Control, size_t... Idx>
__attribute__((no_sanitize("undefined"))) ALWAYS_INLINE static T shuffle_or_0_impl(T a, Control control, IndexSequence<Idx...>)
{
    constexpr Conditional<IsSigned<ElementOf<Control>>, ssize_t, size_t> N = vector_length<T>;
    using E = ElementOf<T>;
    ...
    //       and may be more powerful than the other two as it seems to be able to use bigger item widths than a byte
