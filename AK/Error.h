...
public:
    ...
    constexpr static Error __jakt_from_string_literal(T string)
    {
...
private:
    ...
    // FIXME: This is a workaround for the fact that the Variant based approach allowed this, somehow
    //        And at least one users triggers this
    AK_IGNORE_DIAGNOSTIC("-Wgnu-variable-sized-type-not-at-end", union {
        T m_value;
        ErrorType m_error; };)
#else // GCC:
    union {
