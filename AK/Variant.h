...
// FIXME: The following comment is outdated
//        We now keep the first instance of a type, which might be slower to resolve
//        But is needed, as this mechanism is used for overload resolution and has to match index lookup
