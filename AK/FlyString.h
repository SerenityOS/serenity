...
public:
    ...
    bool operator!=(StringView const& string) const { return !(*this == string); }
    ...
    bool starts_with(StringView const&, CaseSensitivity = CaseSensitivity::CaseSensitive) const;
    bool ends_with(StringView const&, CaseSensitivity = CaseSensitivity::CaseSensitive) const;
