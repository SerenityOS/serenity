...
ErrorOr<int> serenity_main(Main::Arguments arguments)
{
    ...
    TRY(args_parser.add_option(generated_header_path, "Path to the ValueID header file to generate", "generated-header-path", 'h', "generated-header-path"));
    TRY(args_parser.add_option(generated_implementation_path, "Path to the ValueID implementation file to generate", "generated-implementation-path", 'c', "generated-implementation-path"));
