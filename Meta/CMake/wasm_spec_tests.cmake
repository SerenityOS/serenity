if(INCLUDE_WASM_SPEC_TESTS)
    ...
    if(EXISTS ${WASM_SPEC_TEST_GZ_PATH} AND NOT EXISTS ${WASM_SPEC_TEST_PATH})
        ...
        if (CMAKE_VERSION VERSION_LESS 3.18.0)
            ...
            file(ARCHIVE_EXTRACT VERBOSE INPUT ${WASM_SPEC_TEST_GZ_PATH})
        endif()
        file(GLOB WASM_TESTS "${CMAKE_BINARY_DIR}/testsuite-main/*.wast")
        list(LENGTH WASM_TESTS WASM_TEST_COUNT)
        if(${WASM_TEST_COUNT} EQUAL 0)
            message(FATAL_ERROR "Failed to extract any tests from ${WASM_SPEC_TEST_GZ_PATH} (downloaded from ${WASM_SPEC_TEST_GZ_URL})")
        endif()
