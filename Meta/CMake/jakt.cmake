...
function(strip_genex arg out_args)
    string(REPLACE "$<SEMICOLON>" ";" stripped "${arg}")
    string(REPLACE "$<$<COMPILE_LANGUAGE:CXX,OBJCXX>:" "" stripped "${stripped}")
    string(REPLACE ">" "" stripped "${stripped}")
    set(${out_args} ${stripped} PARENT_SCOPE)
endfunction()
...
function(add_jakt_executable target source)
    ...
    foreach(raw_flag IN LISTS compile_flags)
        strip_genex("${raw_flag}" stripped_flags)
        foreach(flag IN LISTS stripped_flags)
