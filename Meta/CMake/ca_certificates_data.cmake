...
set(CACERT_VERSIONED_PATH "${CACERT_PATH}/${CACERT_VERSION}")
...
if (ENABLE_CACERT_DOWNLOAD)
    download_file("${CACERT_URL}" "${CACERT_VERSIONED_PATH}/${CACERT_FILE}")
    ...
    configure_file(${CACERT_VERSIONED_PATH}/${CACERT_FILE} ${CACERT_INSTALL_PATH} COPYONLY)
endif()
