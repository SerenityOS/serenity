...
public:
    static ErrorOr<NonnullRefPtr<MemoryBackedHostBridge>> create(Domain const&, RefPtr<Bus> parent_bus, PhysicalAddress);
...
protected:
    ...
    MemoryBackedHostBridge(PCI::Domain const&, NonnullRefPtr<Bus> root_bus, PhysicalAddress);
