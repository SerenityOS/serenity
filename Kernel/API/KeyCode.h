...
#define ENUMERATE_KEY_CODES                              \
    ...
    __ENUMERATE_KEY_CODE(WWWSearch, "WWWSearch")         \
    __ENUMERATE_KEY_CODE(WWWFavourites, "WWWFavourites") \
    __ENUMERATE_KEY_CODE(WWWHome, "WWWHome")             \
    __ENUMERATE_KEY_CODE(PreviousTrack, "PreviousTrack") \
    __ENUMERATE_KEY_CODE(WWWBack, "WWWBack")             \
    __ENUMERATE_KEY_CODE(WWWForward, "WWWForward")       \
    __ENUMERATE_KEY_CODE(WWWRefresh, "WWWRefresh")       \
    __ENUMERATE_KEY_CODE(WWWStop, "WWWStop")             \
    __ENUMERATE_KEY_CODE(VolumeDown, "VolumeDown")       \
    __ENUMERATE_KEY_CODE(VolumeUp, "VolumeUp")           \
    __ENUMERATE_KEY_CODE(CursorRight, "CursorRight")     \
    __ENUMERATE_KEY_CODE(CursorUp, "CursorUp")           \
    __ENUMERATE_KEY_CODE(CursorDown, "CursorDown")       \
    __ENUMERATE_KEY_CODE(CursorLeft, "CursorLeft")       \
