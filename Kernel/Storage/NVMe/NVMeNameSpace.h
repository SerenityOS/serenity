...
public:
    ...
    explicit NVMeNameSpace(NonnullRefPtrVector<NVMeQueue> queues, size_t storage_size, size_t lba_size, DeviceID, u16 nsid, NonnullOwnPtr<KString> early_device_name);
