...
RamdiskDevice::RamdiskDevice(const RamdiskController&, NonnullOwnPtr<Memory::Region>&& region, int major, int minor)
    : StorageDevice(major, minor, 512, region->size() / 512)
