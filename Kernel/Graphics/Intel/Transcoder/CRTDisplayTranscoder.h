...
class IntelCRTDisplayTranscoder final : public IntelDisplayTranscoder {
public:
    static ErrorOr<NonnullOwnPtr<IntelCRTDisplayTranscoder>> create_with_physical_addresses(PhysicalAddress transcoder_registers_start_address,
...
private:
    ...
    IntelCRTDisplayTranscoder(Memory::TypedMapping<TranscoderRegisters volatile>, Memory::TypedMapping<PipeRegisters volatile>, Memory::TypedMapping<DPLLRegisters volatile>, Memory::TypedMapping<DPLLControlRegisters volatile>);
