...
{
    auto registers_mapping = TRY(Memory::map_typed<TranscoderRegisters volatile>(transcoder_registers_start_address, sizeof(TranscoderRegisters), Memory::Region::Access::ReadWrite));
