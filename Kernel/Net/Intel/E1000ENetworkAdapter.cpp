...
UNMAP_AFTER_INIT ErrorOr<NonnullRefPtr<NetworkAdapter>> E1000ENetworkAdapter::create(PCI::DeviceIdentifier const& pci_device_identifier)
{
    ...
    auto rx_descriptors_region = TRY(Memory::allocate_dma_region_as_typed_array<E1000::RxDescriptor volatile>(number_of_rx_descriptors, "E1000 RX Descriptors"sv, Memory::Region::Access::ReadWrite));
    auto tx_descriptors_region = TRY(Memory::allocate_dma_region_as_typed_array<E1000::TxDescriptor volatile>(number_of_tx_descriptors, "E1000 TX Descriptors"sv, Memory::Region::Access::ReadWrite));
...
UNMAP_AFTER_INIT u16 E1000ENetworkAdapter::read_eeprom(u16 address)
{
