...
public:
    ...
    SpinlockProtected<NonnullRefPtr<Custody>, LockRank::None>& custody() { return m_custody; }
    SpinlockProtected<NonnullRefPtr<Custody>, LockRank::None> const& custody() const { return m_custody; }
    ...
    struct Attributes {
        SetOnce was_attached_by_process;
        SetOnce immutable;
    };
...
private:
    ...
    SpinlockProtected<NonnullRefPtr<Custody>, LockRank::None> m_custody;
