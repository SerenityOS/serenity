...
UNMAP_AFTER_INIT ErrorOr<void> HIDManagement::enumerate()
{
    ...
    if (!has_i8042_controller)
        return {};
    auto i8042_enable_first_port_translation = kernel_command_line().i8042_enable_first_port_translation() ? I8042Controller::EnableFirstPortTranslation::Yes : I8042Controller::EnableFirstPortTranslation::No;
