...
NS16550::NS16550(NonnullOwnPtr<IOWindow> registers_io_window, unsigned minor)
...
bool NS16550::can_read(OpenFileDescription const&, u64) const
{
    return (get_line_status() & DataReady) != 0;
}

ErrorOr<size_t> NS16550::read(OpenFileDescription&, u64, UserOrKernelBuffer& buffer, size_t size)
{
    if (!size)
        return 0;
...
bool NS16550::can_write(OpenFileDescription const&, u64) const
{
    return (get_line_status() & EmptyTransmitterHoldingRegister) != 0;
}

ErrorOr<size_t> NS16550::write(OpenFileDescription& description, u64, UserOrKernelBuffer const& buffer, size_t size)
{
    if (!size)
        return 0;
...
void NS16550::set_interrupts(bool interrupt_enable)
{
...
void NS16550::set_baud(Baud baud)
{
    m_baud = baud;
...
void NS16550::set_fifo_control(u8 fifo_control)
{
    m_fifo_control = fifo_control;
    m_registers_io_window->write8(2, fifo_control);
}

void NS16550::set_line_control(ParitySelect parity_select, StopBits stop_bits, WordLength word_length)
{
...
void NS16550::set_break_enable(bool break_enable)
{
...
void NS16550::set_modem_control(u8 modem_control)
{
...
u8 NS16550::get_line_status() const
{
