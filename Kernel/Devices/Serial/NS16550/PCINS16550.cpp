...
UNMAP_AFTER_INIT void PCINS16550::detect()
{
    ...
    MUST(PCI::enumerate([&](PCI::DeviceIdentifier const& device_identifier) {
        for (auto& board_definition : board_definitions) {
            ...
            for (size_t i = 0; i < board_definition.port_count; i++) {
                ...
                auto serial_device = Device::try_create_device<NS16550>(move(port_registers_io_window), current_device_minor++).release_value_but_fixme_should_propagate_errors();
