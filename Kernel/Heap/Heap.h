...
public:
    ...
    {
        // We can't align anything less than CHUNK_SIZE, presumably due to edge cases in the bitmap calculation.
        // Not that it really matters, we track only chunks, nothing smaller.
        ...
        VERIFY(first_chunk.value() <= aligned_first_chunk && aligned_first_chunk <= first_chunk.value() + chunk_alignment);
