...
void PowerStateSwitchTask::power_state_switch_task(void* raw_entry_data)
{
    ...
    switch (auto const entry_data = bit_cast<PowerStateCommand>(raw_entry_data)) {
...
void PowerStateSwitchTask::spawn(PowerStateCommand const command)
{
...
ErrorOr<void> PowerStateSwitchTask::perform_shutdown(PowerStateSwitchTask::DoReboot const do_reboot)
{
