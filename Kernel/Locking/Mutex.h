...
public:
    ...
    //  Note: Currently this is the LockRank of the internal Spinlock
    ...
    // FIXME: Maybe this should also have a more permanent effect on the lock rank and return some kind of key
