...
ErrorOr<void> I8042Controller::send_command(PS2PortIndex port_index, PS2DeviceCommand command)
{
    ...
    case PS2DeviceCommand::EnablePacketStreaming:
        return send_command_to_specific_port(port_index, I8042Command::EnablePacketStreaming);
    case PS2DeviceCommand::DisablePacketStreaming:
        return send_command_to_specific_port(port_index, I8042Command::DisablePacketStreaming);
    case PS2DeviceCommand::SetDefaults:
        return send_command_to_specific_port(port_index, I8042Command::SetDefaults);
...
ErrorOr<void> I8042Controller::send_command(PS2PortIndex port_index, PS2DeviceCommand command, u8 data)
{
    ...
    case PS2DeviceCommand::SetSampleRate:
        return send_command_to_specific_port(port_index, I8042Command::SetSampleRate, data);
...
ErrorOr<void> I8042Controller::do_send_command(PS2PortIndex port_index, u8 command)
{
    VERIFY(m_lock.is_locked());
...
ErrorOr<void> I8042Controller::do_send_command(PS2PortIndex port_index, u8 command, u8 data)
{
    VERIFY(m_lock.is_locked());
...
ErrorOr<void> I8042Controller::do_write_to_device(PS2PortIndex port_index, u8 data)
{
    VERIFY(m_lock.is_locked());
