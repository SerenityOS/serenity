...
public:
    ...
    static ErrorOr<NonnullOwnPtr<VMWareMouseDevice>> try_to_initialize(PS2Controller const&, PS2PortIndex, MouseDevice const&);
...
private:
    VMWareMouseDevice(PS2Controller const&, PS2PortIndex, MouseDevice const&);
};
