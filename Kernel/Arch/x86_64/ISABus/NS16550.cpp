...
UNMAP_AFTER_INIT NonnullRefPtr<NS16550> NS16550::must_create(size_t com_number)
{
    ...
    case 0: {
        ...
        serial_device = Device::try_create_device<NS16550>(move(io_window), 0).release_value();
        break;
    }
    case 1: {
        ...
        serial_device = Device::try_create_device<NS16550>(move(io_window), 1).release_value();
        break;
    }
    case 2: {
        ...
        serial_device = Device::try_create_device<NS16550>(move(io_window), 2).release_value();
        break;
    }
    case 3: {
        ...
        serial_device = Device::try_create_device<NS16550>(move(io_window), 3).release_value();
        break;
    }
    default:
        break;
