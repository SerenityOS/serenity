...
UNMAP_AFTER_INIT NonnullRefPtr<Serial16550> Serial16550::must_create(size_t com_number)
{
    // FIXME: This way of blindly doing release_value is really not a good thing, find
    // a way to propagate errors back.
    RefPtr<Serial16550> serial_device;
    switch (com_number) {
    case 0: {
        ...
        serial_device = Device::try_create_device<Serial16550>(move(io_window), 0).release_value();
        break;
    }
    case 1: {
        ...
        serial_device = Device::try_create_device<Serial16550>(move(io_window), 1).release_value();
        break;
    }
    case 2: {
        ...
        serial_device = Device::try_create_device<Serial16550>(move(io_window), 2).release_value();
        break;
    }
    case 3: {
        ...
        serial_device = Device::try_create_device<Serial16550>(move(io_window), 3).release_value();
        break;
    }
    default:
        break;
