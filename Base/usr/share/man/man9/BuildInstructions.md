...
If you're on Windows you can use WSL2 to build SerenityOS. Please have a look at the [Windows guide](../man9/BuildInstructionsWindows.md)
for details.
...
* [Other Linux distributions and \*NIX systems](../man9/BuildInstructionsOther.md)
* [macOS](../man9/BuildInstructionsMacOS.md)
...
At this point you should have a fully functioning VM for SerenityOS. The [advanced build instructions guide](../man9/AdvancedBuildInstructions.md)
