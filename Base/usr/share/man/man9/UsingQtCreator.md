...
First, make sure you have a working toolchain and can build and run SerenityOS. Go [here](help://man/9/BuildInstructions) for instructions for setting that up.
...
You can use `clang-format` to help you with the [style guide](help://man/9/CodingStyle). Before you proceed, check that you're actually using clang-format version 14, as some OSes will ship older clang-format versions by default.
